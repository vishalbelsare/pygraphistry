...
export const VectorGraph = $root.VectorGraph = (() => {
    ...
    VectorGraph.encode = function encode(message, writer) {
        ...
        if (message.edges != null && message.edges.length)
            for (let i = 0; i < message.edges.length; ++i)
                $root.VectorGraph.Edge.encode(message.edges[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        if (message.uint32_vectors != null && message.uint32_vectors.length)
            for (let i = 0; i < message.uint32_vectors.length; ++i)
                $root.VectorGraph.UInt32AttributeVector.encode(message.uint32_vectors[i], writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
        if (message.double_vectors != null && message.double_vectors.length)
            for (let i = 0; i < message.double_vectors.length; ++i)
                $root.VectorGraph.DoubleAttributeVector.encode(message.double_vectors[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
        if (message.string_vectors != null && message.string_vectors.length)
            for (let i = 0; i < message.string_vectors.length; ++i)
                $root.VectorGraph.StringAttributeVector.encode(message.string_vectors[i], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
        if (message.int32_vectors != null && message.int32_vectors.length)
            for (let i = 0; i < message.int32_vectors.length; ++i)
                $root.VectorGraph.Int32AttributeVector.encode(message.int32_vectors[i], writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
        if (message.int64_vectors != null && message.int64_vectors.length)
            for (let i = 0; i < message.int64_vectors.length; ++i)
                $root.VectorGraph.Int64AttributeVector.encode(message.int64_vectors[i], writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
        if (message.float_vectors != null && message.float_vectors.length)
            for (let i = 0; i < message.float_vectors.length; ++i)
                $root.VectorGraph.FloatAttributeVector.encode(message.float_vectors[i], writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
        if (message.bool_vectors != null && message.bool_vectors.length)
            for (let i = 0; i < message.bool_vectors.length; ++i)
                $root.VectorGraph.BoolAttributeVector.encode(message.bool_vectors[i], writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
        if (message.bindings != null && message.hasOwnProperty("bindings"))
            $root.VectorGraph.Bindings.encode(message.bindings, writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
        return writer;
    };
    ...
    VectorGraph.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph();
        while (reader.pos < end) {
            ...
            case 7:
                ...
                message.uint32_vectors.push($root.VectorGraph.UInt32AttributeVector.decode(reader, reader.uint32()));
                break;
            case 8:
                if (!(message.double_vectors && message.double_vectors.length))
                    message.double_vectors = [];
                message.double_vectors.push($root.VectorGraph.DoubleAttributeVector.decode(reader, reader.uint32()));
                break;
            case 9:
                if (!(message.string_vectors && message.string_vectors.length))
                    message.string_vectors = [];
                message.string_vectors.push($root.VectorGraph.StringAttributeVector.decode(reader, reader.uint32()));
                break;
            case 10:
                if (!(message.int32_vectors && message.int32_vectors.length))
                    message.int32_vectors = [];
                message.int32_vectors.push($root.VectorGraph.Int32AttributeVector.decode(reader, reader.uint32()));
                break;
            case 11:
                if (!(message.int64_vectors && message.int64_vectors.length))
                    message.int64_vectors = [];
                message.int64_vectors.push($root.VectorGraph.Int64AttributeVector.decode(reader, reader.uint32()));
                break;
            case 12:
                if (!(message.float_vectors && message.float_vectors.length))
                    message.float_vectors = [];
                message.float_vectors.push($root.VectorGraph.FloatAttributeVector.decode(reader, reader.uint32()));
                break;
            case 13:
                if (!(message.bool_vectors && message.bool_vectors.length))
                    message.bool_vectors = [];
                message.bool_vectors.push($root.VectorGraph.BoolAttributeVector.decode(reader, reader.uint32()));
                break;
            case 14:
    ...
    VectorGraph.Edge = (function() {
        ...
        Edge.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.Edge();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.UInt32AttributeVector = (function() {
        ...
        UInt32AttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.UInt32AttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.Int32AttributeVector = (function() {
        ...
        Int32AttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.Int32AttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.Int64AttributeVector = (function() {
        ...
        Int64AttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.Int64AttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.FloatAttributeVector = (function() {
        ...
        FloatAttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.FloatAttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.DoubleAttributeVector = (function() {
        ...
        DoubleAttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.DoubleAttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.StringAttributeVector = (function() {
        ...
        StringAttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.StringAttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.BoolAttributeVector = (function() {
        ...
        BoolAttributeVector.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.BoolAttributeVector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.Mapping = (function() {
        ...
        Mapping.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.Mapping();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    VectorGraph.Bindings = (function() {
        ...
        Bindings.encode = function encode(message, writer) {
            ...
            if (message.mappings != null && message.mappings.length)
                for (let i = 0; i < message.mappings.length; ++i)
                    $root.VectorGraph.Mapping.encode(message.mappings[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        Bindings.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.VectorGraph.Bindings();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 4:
                    if (!(message.mappings && message.mappings.length))
                        message.mappings = [];
                    message.mappings.push($root.VectorGraph.Mapping.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
