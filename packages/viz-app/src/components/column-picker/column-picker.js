...
const ColumnPickerTooltip = <Tooltip id="ColumnPickerTooltip">Configure Inspector</Tooltip>;
...
export class ColumnPicker extends React.Component {
  ...
  render() {
    ...
    return (
      <OverlayTrigger placement="top" delayShow={350} overlay={ColumnPickerTooltip}>
        <Button onClick={this.open} style={this.props.style}>
          <i
          ...
          <Modal
            ...
            onHide={this.close}
            dialogClassName={styles['column-picker-modal']}>
              ...
              <Select
                ...
                onChange={values => {
                  return this.props.onChange(
                    !values ? [] : ('' + values).split(',').map(idx => options[idx])
                  );
                }}
              />
            </Modal.Body>
