    ...
    return class AppRouter extends AppRouterBase {
        ...
        get(paths) {
            return super.get(paths).do(null, (err) => {
                if (err instanceof JSONGraphError || err instanceof CallNotFoundError ||
                    err instanceof MaxPathsExceededError || err instanceof CallRequiresPathsError) {
                    logger.error(
