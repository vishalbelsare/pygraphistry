    ...
    return function loadLabelByIndexAndType({ offsets, labelType, labelIndex }) {
        ...
        return labelType in labelsByType
            ...
            : (labelsByType[labelType] = Observable.defer(() => {
                  ...
                  const upperBound =
                      labelIndex < offsets.length ? offsets[labelIndex + 1] - 1 : undefined; // Upper bound will be undefined for last label
                  ...
                  const byteEnd =
                      upperBound !== undefined && upperBound.toString
                          ? upperBound.toString(10)
                          : '';
                  const byteStart =
                      lowerBound !== undefined && lowerBound.toString
                          ? lowerBound.toString(10)
                          : '';
