...
describe('confirmType', function() {
    describe('empty', function() {
        ['string', 'double', 'integer', 'empty'].forEach(wrongType =>
    ...
    describe('int', function() {
        ['string', 'integer', 'double', 'empty'].forEach(wrongType =>
            describe(wrongType, function() {
                ...
                it('mixed nulls', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 1 }, {}, { z: null }], 'z'),
                        'integer'
                    );
                });
    ...
    describe('double', function() {
        ['string', 'integer', 'double', 'empty'].forEach(wrongType =>
            describe(wrongType, function() {
                ...
                it('mixed nulls', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 1.5 }, {}, { z: null }], 'z'),
                        'double'
                    );
                });
                ...
                it('mixed numbers 1', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 1.5 }, {}, { z: 2 }], 'z'),
                        'double'
                    );
                });
                ...
                it('mixed numbers 2', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 1 }, {}, { z: 2.5 }], 'z'),
                        'double'
                    );
                });
    ...
    describe('string', function() {
        ['string', 'integer', 'double', 'empty'].forEach(wrongType =>
            describe(wrongType, function() {
                ...
                it('mixed nulls', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 'z1.5' }, {}, { z: null }], 'z'),
                        'string'
                    );
                });
                ...
                it('mixed numbers', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 'z1.5' }, {}, { z: 2.5 }], 'z'),
                        'string'
                    );
                });
                ...
                it('mixed integer', function() {
                    assert.equal(
                        confirmType(wrongType, [{ z: null }, { z: 'z1.5' }, {}, { z: 2 }], 'z'),
                        'string'
                    );
                });
            })
