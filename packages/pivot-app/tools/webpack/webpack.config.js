...
const GaugeProgressBarPlugin = require('gauge-webpack-plugin');
...
function makeWebpackConfig(
    ...
    const baseConfig = {
        ...
        output: Object.assign(
            {
                publicPath: '',
                // Don't use hash in development it will increase compilation time
        ...
        plugins: (isNodemonWatching
            ...
            new StatsPlugin(`${statsPath}/${type}-stats.json`, {
                chuckModules: true,
                chucks: true,
                timings: true
            })
    ...
    return addAliases(
        options,
        addEntries(options, addBabelRules(options, addStyleRules(options, baseConfig)))
    );
}
