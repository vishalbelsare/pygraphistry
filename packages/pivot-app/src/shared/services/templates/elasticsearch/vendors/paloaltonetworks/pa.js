...
export const defaultFields = [
    ...
    'action_flags',
    'app',
    'app_able_to_transfer_file',
    'app_category',
    'app_default_ports',
    'app_evasive',
    'app_excessive_bandwidth',
    'app_has_known_vulnerability',
    'app_is_saas',
    'app_is_sanctioned_saas',
    'app_pervasive_use',
    'app_prone_to_misuse',
    'app_risk',
    'app_subcategory',
    'app_technology',
    'app_tunnels_other_application',
    'app_used_by_malware',
    'application',
    'cid',
    'client_ip',
...
export const desiredEntities = ['client_ip', 'rule', 'threat_name', 'user'];
