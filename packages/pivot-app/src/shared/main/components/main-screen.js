...
function MainScreen({
    user, investigations, numTemplates,
    switchScreen, setInvestigationParams,
    copyInvestigation, createInvestigation,
    selectInvestigation, selectHandler, deleteHandler
}) {
    ...
    return (
        <Panel className={mainStyles['main-panel-panel']}>
            ...
            <Panel header="Open Investigations" className={mainStyles.panel}>
                ...
                <InvestigationTable switchScreen={switchScreen}
