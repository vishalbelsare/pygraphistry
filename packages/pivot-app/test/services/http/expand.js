...
describe('HttpExpand', function () {
    ...
    it('constant', function (done) {    
        assert.deepEqual(
            ...
            [
                {url: 'http://www.google.com', params: {x: 1, endpoint: 'http://www.google.com', pRef: 0}}, 
                {url: 'http://www.google.com', params: {x: 3, endpoint: 'http://www.google.com', pRef: 0}}]);
        done();
    });
    ...
    it('row params', function (done) {  
        assert.deepEqual(
            HTTP_EXPAND.toUrls(
                ...
                [{events: [{x: 1}, {x: 3}]}, {events: []}, {events: []}]),
            [{url: 'http://www.google.com/?v=1', params: {x: 1, endpoint: 'http://www.google.com/?v={x}', pRef: 0}}, 
             {url: 'http://www.google.com/?v=3', params: {x: 3, endpoint: 'http://www.google.com/?v={x}', pRef: 0}}]);
        done();
    });
    ...
    it('row params 2nd', function (done) {  
        assert.deepEqual(
            ...
            [{url: 'http://www.google.com/?v=z', params: {y: 'z', endpoint: 'http://www.google.com/?v={y}', pRef: 1}}]);
        done();
    });
    ...
    it('pivot params', function (done) {  
        assert.deepEqual(
            HTTP_EXPAND.toUrls(
                ...
                [{events: [{x: 1}, {x: 3}]}, {events: []}, {events: []}]),
            [{url: 'http://www.google.com/?v=1&f=z', params: {x: 1, endpoint: 'http://www.google.com/?v={x}&f={y}', pRef: 0, y: 'z'}}, 
             {url: 'http://www.google.com/?v=3&f=z', params: {x: 3, endpoint: 'http://www.google.com/?v={x}&f={y}', pRef: 0, y: 'z'}}]);
        done();
    });
