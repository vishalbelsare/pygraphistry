        ...
        MANUAL.searchAndShape({
            ...
            .subscribe(({pivot, ...rest}) => {
                    ...
                    assert.deepEqual(pivot.results.graph, 
                        [{ ...base2, edge: 'x:0:x', col: 'x', destination: 1, edgeType: 'EventID->x', edgeTitle: 'x:0->1'},
                         { ...base2, edge: 'x:0:y', col: 'y', destination: 'aa', edgeType: 'EventID->y', edgeTitle: 'x:0->aa'},
                         { ...base2, edge: 'x:0:z.0', col: 'z.0', destination: 'a', edgeType: 'EventID->z.0', edgeTitle: 'x:0->a'},
                         { ...base2, edge: 'x:0:z.1', col: 'z.1', destination: 'b', edgeType: 'EventID->z.1', edgeTitle: 'x:0->b'}]);
    ...
    it('valid array', (done) => {
        MANUAL.searchAndShape({
            ...
            .subscribe(({pivot, ...rest}) => {
                    ...
                    assert.deepEqual(pivot.results.graph, 
                        [{ ...base, edge: 'x:0:x', col: 'x', EventID: 'x:0', x:1, destination: 1, 'source': 'x:0', edgeTitle: 'x:0->1'},
                         { ...base, edge: 'x:1:x', col: 'x', EventID: 'x:1', x:3, destination: 3, 'source': 'x:1', edgeTitle: 'x:1->3'}]);
                    assert.deepEqual(pivot.results.labels,
    ...
    it('jq', (done) => {
        MANUAL.searchAndShape({
            ...
            .subscribe(({pivot, ...rest}) => {
                    ...
                    assert.deepEqual(pivot.results.graph, 
                        [{ edgeType: 'EventID->x', col: 'x', edge: 'x:0:x', EventID: 'x:0', x:1, y:2, destination: 1, 'source': 'x:0', edgeTitle: 'x:0->1'},
                         { edgeType: 'EventID->y', col: 'y', edge: 'x:0:y', EventID: 'x:0', x:1, y:2, destination: 2, 'source': 'x:0', edgeTitle: 'x:0->2'}]);
                    assert.deepEqual(pivot.results.labels,
    ...
    it('valid array with EventIDs', (done) => {
        MANUAL.searchAndShape({
            ...
            .subscribe(({pivot, ...rest}) => {
                    ...
                    assert.deepEqual(pivot.results.graph, 
                        [{edge: 'aa:x', col: 'x', EventID: 'aa', x:1, destination: 1, 'source': 'aa', edgeType: 'EventID->x', edgeTitle: 'aa->1'},
                         {edge: 'bb:x', col: 'x', EventID: 'bb', x:3, destination: 3, 'source': 'bb', edgeType: 'EventID->x', edgeTitle: 'bb->3'}]);
                    assert.deepEqual(pivot.results.labels,
