 ...
 * @returns {Number}
 */
Dataframe.prototype.precedenceOf = function (operatorName, fixity) {
    switch (operatorName) {
        case '.':
            return 18;
        case '+':
 ...
 * @returns {String}
 */
Dataframe.prototype.translateOperator = function (operatorString) {
 ...
 */
Dataframe.prototype.wrapSubExpressionPerPrecedences = function (subExprString, precedence, outerPrecedence) {
...
Dataframe.prototype.expressionForFunctionCall = function (inputFunctionName, args, outerPrecedence) {
 ...
 * @returns {String}
 */
Dataframe.prototype.sourceForQueryAST = function (ast, depth, outerPrecedence) {
    ...
    switch (ast.type) {
        ...
        case 'BinaryExpression':
            ...
            args = _.map([ast.left, ast.right], function (arg) {
                return this.sourceForQueryAST(arg, depth + 1, precedence);
            }, this);
        ...
        case 'UnaryExpression':
            ...
            var arg = this.sourceForQueryAST(ast.argument, depth + 1, precedence);
            switch (ast.fixity) {
                case 'prefix':
        ...
        case 'ListExpression':
            args = _.map(ast.arguments, function (arg) {
                return this.sourceForQueryAST(arg, depth + 1, 19);
            }, this);
            return '[' + args.join(', ') + ']';
        case 'FunctionCall':
            args = _.map(ast.arguments, function (arg) {
            ...
            return this.expressionForFunctionCall(this.sourceForQueryAST(ast.callee), args, outerPrecedence);
        case 'Identifier':
