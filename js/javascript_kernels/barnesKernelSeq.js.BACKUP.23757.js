...
<<<<<<< HEAD
    this.boundBox = new Kernel('bound_box', this.argsBarnes2,
            this.argsType, 'barnesHut.cl', clContext);

    this.buildTree = new Kernel('build_tree', this.argsBarnes2,
            this.argsType, 'barnesHut.cl', clContext);

    this.computeSums = new Kernel('compute_sums', this.argsBarnes2,
            this.argsType, 'barnesHut.cl', clContext);

    this.sort = new Kernel('sort', this.argsBarnes2,
            this.argsType, 'barnesHut.cl', clContext);

    this.calculateForces = new Kernel('calculate_forces', this.argsBarnes2,
            this.argsType, 'barnesHut.cl', clContext);

    this.move = new Kernel('move_bodies', this.argsBarnes2,
            this.argsType, 'barnesHut.cl', clContext);
=======
...
>>>>>>> 1dab8c1dcade8e410a40663ea2e8de755d2a8c11
