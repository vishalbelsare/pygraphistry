...
class BinColumn extends React.Component {
    ...
    onBinMouseDown() {
        this.props.onBinMouseDown(this.props.bin);
    }
    onBinMouseOver() {
        this.props.onBinMouseOver(this.props.bin);
    }
    render() {
        ...
        return (
            <OverlayTrigger trigger={['hover']}
                ...
                <div className={`${styles['histogram-column']}
                    ...
                    data-binmax={binMax}
                    onMouseDown={this.onBinMouseDown}
                    onMouseOver={this.onBinMouseOver}
                    style={{
