module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          peg$decode("7)"),
          peg$decode("87\u0109*; \"7\xAC*5 \"7\xEF*/ \"7\xDF*) \"7\xF0*# \"7\xA49*\" 3 "),
          peg$decode("8! #7!+&$,#&7!\"\"\" \"+\x8B$!7`+7$75+-%7a+#%'#%$## \"$\"# \"\"# \"*V \"!7`+K$75+A%7V+7%75+-%7a+#%'%%$%# \"$$# \"$## \"$\"# \"\"# \"*# \" $+#%'\"%$\"# \"\"# \"9*\" 3!"),
          peg$decode("8!7\xB0+\x8D$7\x84+\x83%7`+y%7\x84+o%7)+e%7\x84+[%7\xA5+Q%7\x84+G%7\"+=%7\x84+3%7a+)%4+6&+\"&\"%$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3%"),
          peg$decode("!7\xED+=$7\x84+3%7$+)%4#6'#\"\" %$## \"$\"# \"\"# \"*# \"7"),
          peg$decode("!7$+\x8D$ #!7\x84+A$7\xA3+7%7\x84+-%7$+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x84+A$7\xA3+7%7\x84+-%7$+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6(\"\"! %$\"# \"\"# \""),
          peg$decode("!7%+\x8D$ #!7\x84+A$7\xF4+7%7\x84+-%7%+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x84+A$7\xF4+7%7\x84+-%7%+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6(\"\"! %$\"# \"\"# \""),
          peg$decode("8!7\xE8+<$7\x84+2%7)+(%4#6*#! %$## \"$\"# \"\"# \"9*\" 3)"),
          peg$decode("87&9*\" 3+"),
          peg$decode("7'*# \"7("),
          ...
          peg$decode(" \xB4"),
          peg$decode("!7\xA3+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u03A3 \"!7\xA5+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u037A \"!7\xAA+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0351 \"!7\xAB+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0328 \"!7\xAF+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u02FF \"!7\xB0+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u02D6 \"!7\xC4+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u02AD \"!7\xC5+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0284 \"!7\xC6+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u025B \"!7\xC9+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0232 \"!7\xCF+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0209 \"!7\xD3+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u01E0 \"!7\xD7+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u01B7 \"!7\xE2+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u018E \"!7\xE3+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0165 \"!7\xE7+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u013C \"!7\xED+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\u0113 \"!7\xEE+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\xEA \"!7\xF4+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\xC1 \"!7\u010D+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*\x98 \"!7\u010E+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*o \"!7\u011A+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \"*F \"!7\u011B+;$!87<9*$$\"\" 2\"# \"+#%'\"%$\"# \"\"# \""),
          peg$decode("8!7\xEF+& 4!6\xB6! %9*\" 3\xB5"),
          peg$decode("8!7\u0111+& 4!6\xB8! %*. \"!7\xCC+& 4!6\xB9! %9*\" 3\xB7"),
          ...
          peg$decode("87\xE3*# \"7\xEE9*\" 3\xDC"),
          peg$decode("!7\x90+=$7\x84+3%7\x86+)%4#6\xDD#\"\" %$## \"$\"# \"\"# \""),
          peg$decode("!7\x90+R$7\x84+H%7\xE2+>%7\x84+4%7\x93+*%4%6\xDE%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x90+R$7\x84+H%7\xD7+>%7\x84+4%7)+*%4%6\xDF%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*\xCD \"!7\x90+\xC2$7\x84+\xB8%7\xD7+\xAE%7\x84+\xA4%7`+\x9A% #!7\x90+7$7V+-%7\x84+#%'#%$## \"$\"# \"\"# \"+E$,B&!7\x90+7$7V+-%7\x84+#%'#%$## \"$\"# \"\"# \"\"\"\" \"*# \" $+=%7\x84+3%7a+)%4(6\xE0(\"'%%$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x90+z$7\x84+p%7\xAB+f%7\x84+\\%7\x90+R%7\x84+H%7\xA3+>%7\x84+4%7\x90+*%4)6\xE1)#($ %$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("87\xE7*# \"7\xD59*\" 3\xE2"),
          peg$decode("8!7\x90+q$7\x84+g%7\x8B+]%7\x84+S%7\x90+I%7\x84+?%7\xC6+5%7F++%4(6\xE3($'%# %$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*] \"!7\x90+R$7\x84+H%7\x8B+>%7\x84+4%7\x90+*%4%6\xE4%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xE2"),
          peg$decode("7\xFD*B \"!7\u0108+7$7\x84+-%7\u010E+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("8!7\x90+R$7\x84+H%7\x8D+>%7\x84+4%7\x90+*%4%6\xE6%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xE5"),
          peg$decode("8!7\xED+=$7\x84+3%7\x91+)%4#6\xE8#\"\" %$## \"$\"# \"\"# \"9*\" 3\xE7"),
          ...
          peg$decode("/\u012A\"\"1(3\u012B"),
          peg$decode("/\u012C\"\"1*3\u012D"),
          peg$decode("!7\x84+3$/\u012E\"\"1&3\u012F+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u0130\"\"1%3\u0131"),
          peg$decode("/\u0132\"\"1(3\u0133"),
          peg$decode("/\u0134\"\"1'3\u0135"),
          peg$decode("/\u0136\"\"1*3\u0137"),
          peg$decode("/\u0138\"\"1(3\u0139"),
          peg$decode("!7\x84+3$/\u013A\"\"1&3\u013B+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u013C\"\"1$3\u013D"),
          peg$decode("/\u013E\"\"1&3\u013F"),
          peg$decode("/\u0140\"\"1(3\u0141"),
          peg$decode("/\u0142\"\"1$3\u0143"),
          ...
          peg$decode("/\u01BD\"\"1'3\u01BE"),
          peg$decode("/\u01BF\"\"1&3\u01C0"),
          peg$decode("!7\x84+3$/\u01C1\"\"1'3\u01C2+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01C3\"\"1(3\u01C4"),
          peg$decode("/\u01C5\"\"1(3\u01C6"),
          peg$decode("/\u01C7\"\"1#3\u01C8"),
          peg$decode("/\u01C9\"\"1)3\u01CA"),
          peg$decode("!7\x84+3$/\u01CB\"\"1&3\u01CC+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01CD\"\"1#3\u01CE"),
          peg$decode("/\u01CF\"\"1'3\u01D0"),
          peg$decode("/\u01D1\"\"1&3\u01D2"),
          peg$decode("/\u01D3\"\"1%3\u01D4"),
