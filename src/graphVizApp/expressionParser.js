module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          peg$decode("7."),
          peg$decode("87\u0110*M \"7\xB2*G \"7\xF6*A \"7\xE6*; \"7\xF7*5 \"7\xAA*/ \"7\xC0*) \"7\u0115*# \"7\u01169*\" 3 "),
          peg$decode("8! #7!+&$,#&7!\"\"\" \"+\x8B$!7g+7$7<+-%7h+#%'#%$## \"$\"# \"\"# \"*V \"!7g+K$7<+A%7]+7%7<+-%7h+#%'%%$%# \"$$# \"$## \"$\"# \"\"# \"*# \" $+#%'\"%$\"# \"\"# \"9*\" 3!"),
          peg$decode("8!7\xB6+\x8D$7\x8B+\x83%7g+y%7\x8B+o%7,+e%7\x8B+[%7\xAB+Q%7\x8B+G%7\"+=%7\x8B+3%7h+)%4+6&+\"&\"%$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3%"),
          peg$decode("8!!7\u0123+e$7\x8B+[%7,+Q%7\x8B+G%7\u0114+=%7\x8B+3%7,+)%4'6('\"$ %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"+\xE9$ #!7\x8B+o$7\u0123+e%7\x8B+[%7,+Q%7\x8B+G%7\u0114+=%7\x8B+3%7,+)%4(6((\"$ %$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \",z&!7\x8B+o$7\u0123+e%7\x8B+[%7,+Q%7\x8B+G%7\u0114+=%7\x8B+3%7,+)%4(6((\"$ %$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"6)\"\"! %$\"# \"\"# \"9*\" 3'"),
          peg$decode("8!7\xB5+e$7\x8B+[%7,+Q%7\x8B+G%7$+=%7\x8B+3%7\xCC+)%4'6+'\"$\"%$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\u013E \"!7\xB5+P$7\x8B+F%7$+<%7\x8B+2%7\xCC+(%4%6,%!\"%$%# \"$$# \"$## \"$\"# \"\"# \"*\u0100 \"!7\xB5+\x8E$7\x8B+\x84%7,+z%7\x8B+p%7$+f%7\x8B+\\%7\xCB+R%7\x8B+H%7,+>%7\x8B+4%7\xCC+*%4+6-+#(&\"%$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\x84 \"!7\xB5+y$7\x8B+o%7$+e%7\x8B+[%7\xCB+Q%7\x8B+G%7,+=%7\x8B+3%7\xCC+)%4)6.)\"&\"%$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3*"),
          peg$decode("!!7\xDA+e$7\x8B+[%7,+Q%7\x8B+G%7\u0114+=%7\x8B+3%7,+)%4'6/'\"$ %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"+\u0111$ #!7\x8B+\x83$7\xCB+y%7\x8B+o%7\xDA+e%7\x8B+[%7,+Q%7\x8B+G%7\u0114+=%7\x8B+3%7,+)%4*6/*\"$ %$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \",\x8E&!7\x8B+\x83$7\xCB+y%7\x8B+o%7\xDA+e%7\x8B+[%7,+Q%7\x8B+G%7\u0114+=%7\x8B+3%7,+)%4*6/*\"$ %$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"6)\"\"! %$\"# \"\"# \""),
          peg$decode("8!7&+<$7\x8B+2%7\xCC+(%4#61#!\"%$## \"$\"# \"\"# \"*p \"!7&+e$7\x8B+[%7\xCB+Q%7\x8B+G%7,+=%7\x8B+3%7\xCC+)%4'62'\"&\"%$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 30"),
          peg$decode("8!7\xF4+=$7\x8B+3%7(+)%4#64#\"\" %$## \"$\"# \"\"# \"*# \"7\x869*\" 33"),
          peg$decode("!7(+\x8D$ #!7\x8B+A$7\xA9+7%7\x8B+-%7(+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\xA9+7%7\x8B+-%7(+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"65\"\"! %$\"# \"\"# \""),
          peg$decode("!7)+\x8D$ #!7\x8B+A$7\xFB+7%7\x8B+-%7)+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\xFB+7%7\x8B+-%7)+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"65\"\"! %$\"# \"\"# \""),
          peg$decode("8!7\xEF+<$7\x8B+2%7,+(%4#67#! %$## \"$\"# \"\"# \"9*\" 36"),
          peg$decode("7%*) \"7'*# \"7*"),
          peg$decode("87,9*\" 38"),
          peg$decode("7+*# \"7-"),
          peg$decode("87\x9F*) \"7\xA0*# \"7\xA19*\" 39"),
          ...
          peg$decode(" \xC6"),
          peg$decode("!7\xA9+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u03F5 \"!7\xAB+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u03CC \"!7\xB0+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u03A3 \"!7\xB1+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u037A \"!7\xB5+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0351 \"!7\xB6+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0328 \"!7\xCB+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u02FF \"!7\xCC+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u02D6 \"!7\xCD+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u02AD \"!7\xD0+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0284 \"!7\xD6+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u025B \"!7\xDA+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0232 \"!7\xDE+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0209 \"!7\xE9+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u01E0 \"!7\xEA+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u01B7 \"!7\xEE+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u018E \"!7\xF4+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0165 \"!7\xF5+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u013C \"!7\xFB+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\u0113 \"!7\u0104+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\xEA \"!7\u010F+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\xC1 \"!7\u0114+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*\x98 \"!7\u0117+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*o \"!7\u0123+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \"*F \"!7\u0124+;$!87C9*$$\"\" A\"# \"+#%'\"%$\"# \"\"# \""),
          peg$decode("8!7\xF6+& 4!6\xC8! %9*\" 3\xC7"),
          peg$decode("8!7\u011A+& 4!6\xCA! %*. \"!7\xD3+& 4!6\xCB! %9*\" 3\xC9"),
          peg$decode("87|*) \"7}*# \"7~9*\" 3\xCC"),
          peg$decode("7b*# \"7a"),
          peg$decode("!7\x9A+\x8D$ #!7\x8B+A$7\x80+7%7\x8B+-%7\x9A+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\x80+7%7\x8B+-%7\x9A+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xCD\"\"! %$\"# \"\"# \""),
          ...
          peg$decode("!7\x83+\x8D$ #!7\x8B+A$7\x84+7%7\x8B+-%7\x83+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\x84+7%7\x8B+-%7\x83+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"65\"\"! %$\"# \"\"# \"*# \"7\x93"),
          ...
          peg$decode("87\xEA*# \"7\xF59*\" 3\xEE"),
          peg$decode("!7\x96+=$7\x8B+3%7\x8D+)%4#6\xEF#\"\" %$## \"$\"# \"\"# \""),
          peg$decode("!7\x96+R$7\x8B+H%7\xE9+>%7\x8B+4%7\x99+*%4%6\xF0%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x96+g$7\x8B+]%7\xE9+S%7\x8B+I%7\xF4+?%7\x8B+5%7\x99++%4'6\xF1'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x96+R$7\x8B+H%7\xDE+>%7\x8B+4%7,+*%4%6\xF2%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*\u01E7 \"!7\x96+\xC2$7\x8B+\xB8%7\xDE+\xAE%7\x8B+\xA4%7g+\x9A% #!71+7$7]+-%7\x8B+#%'#%$## \"$\"# \"\"# \"+E$,B&!71+7$7]+-%7\x8B+#%'#%$## \"$\"# \"\"# \"\"\"\" \"*# \" $+=%7\x8B+3%7h+)%4(6\xF3(\"'%%$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\u0137 \"!7\x96+g$7\x8B+]%7\xF4+S%7\x8B+I%7\xDE+?%7\x8B+5%7,++%4'6\xF4'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\xE2 \"!7\x96+\xD7$7\x8B+\xCD%7\xF4+\xC3%7\x8B+\xB9%7\xDE+\xAF%7\x8B+\xA5%7g+\x9B% #!71+7$7]+-%7\x8B+#%'#%$## \"$\"# \"\"# \"+E$,B&!71+7$7]+-%7\x8B+#%'#%$## \"$\"# \"\"# \"\"\"\" \"*# \" $+>%7\x8B+4%7h+*%4*6\xF5*#)'%%$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x96+z$7\x8B+p%7\xB1+f%7\x8B+\\%7\x96+R%7\x8B+H%7\xA9+>%7\x8B+4%7\x96+*%4)6\xF6)#($ %$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\x9A \"!7\x96+\x8F$7\x8B+\x85%7\xF4+{%7\x8B+q%7\xB1+g%7\x8B+]%7\x96+S%7\x8B+I%7\xA9+?%7\x8B+5%7\x96++%4+6\xF7+$*($ %$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("87\xEE*# \"7\xDC9*\" 3\xF8"),
          peg$decode("8!7\x96+q$7\x8B+g%7\x92+]%7\x8B+S%7\x96+I%7\x8B+?%7\xCD+5%7M++%4(6\xF9($'%# %$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\u0126 \"!7\x96+R$7\x8B+H%7\x92+>%7\x8B+4%7\x96+*%4%6\xFA%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*\xE6 \"!7\x96+\x86$7\x8B+|%7\xF4+r%7\x8B+h%7\x92+^%7\x8B+T%7\x96+J%7\x8B+@%7\xCD+6%7M+,%4*6\xFB*%)'%# %$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x96+g$7\x8B+]%7\xF4+S%7\x8B+I%7\x92+?%7\x8B+5%7\x96++%4'6\xFC'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xF8"),
          peg$decode("7\u0104*B \"!7\u010F+7$7\x8B+-%7\u0117+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("8!7\x96+R$7\x8B+H%7\x94+>%7\x8B+4%7\x96+*%4%6\xFE%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x96+g$7\x8B+]%7\xF4+S%7\x8B+I%7\x94+?%7\x8B+5%7\x96++%4'6\xFF'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xFD"),
          peg$decode("!77+\xBF$ #!7\x8B+Z$7i+P%7\x8B+F%7,+<%7\x8B+2%7j+(%4&6\u0100&!\"%$&# \"$%# \"$$# \"$## \"$\"# \"\"# \",e&!7\x8B+Z$7i+P%7\x8B+F%7,+<%7\x8B+2%7j+(%4&6\u0100&!\"%$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\u0101\"\"! %$\"# \"\"# \""),
          peg$decode("7\x93*A \"7\x95*; \"7\x91*5 \"7\x90*/ \"7\x8E*) \"7\x8F*# \"7\x96"),
          peg$decode("87a*) \"7b*# \"7f9*\" 3\u0102"),
          peg$decode("!7\x98+=$7\x8B+3%7\x97+)%4#6\u0103#\"\" %$## \"$\"# \"\"# \"*# \"7\x97"),
          peg$decode("!7\x99+\x8D$ #!7\x8B+A$7\x9B+7%7\x8B+-%7\x99+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\x9B+7%7\x8B+-%7\x99+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xCD\"\"! %$\"# \"\"# \""),
          peg$decode("87c*) \"7d*# \"7e9*\" 3\u0104"),
          peg$decode("! #0\u0105\"\"1!3\u0106+,$,)&0\u0105\"\"1!3\u0106\"\"\" \"+' 4!6\u0107!! %"),
          peg$decode("!!!7E+7$7^+-%7\x9C+#%'#%$## \"$\"# \"\"# \"+' 4!6\u0108!! %*/ \"!7\x9C+' 4!6\u0109!! %+' 4!6\u010A!! %"),
          peg$decode("!.\u010B\"\"2\u010B3\u010C+-$7E+#%'\"%$\"# \"\"# \""),
          peg$decode(".\u010D\"\"2\u010D3\u010E"),
          peg$decode(".\u010D\"\"2\u010D3\u010E"),
          peg$decode(".\u010D\"\"2\u010D3\u010E"),
          peg$decode("/\u010F\"\"1%3\u0110"),
          ...
          peg$decode("/\u01D6\"\"1'3\u01D7"),
          peg$decode("/\u01D8\"\"1&3\u01D9"),
          peg$decode("!7\x8B+3$/\u01DA\"\"1'3\u01DB+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01DC\"\"1(3\u01DD"),
          peg$decode("/\u01DE\"\"1(3\u01DF"),
          peg$decode("/\u01E0\"\"1#3\u01E1"),
          peg$decode("/\u01E2\"\"1)3\u01E3"),
          peg$decode("!7\x8B+3$/\u01E4\"\"1&3\u01E5+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01E6\"\"1#3\u01E7"),
          peg$decode("/\u01E8\"\"1'3\u01E9"),
          peg$decode("/\u01EA\"\"1&3\u01EB"),
          peg$decode("/\u01EC\"\"1%3\u01ED"),
