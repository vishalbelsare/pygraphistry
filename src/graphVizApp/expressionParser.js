  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("8!7&+<$7\x8E+2%7.+(%4#60#! %$## \"$\"# \"\"# \"9*\" 3/"),
          peg$decode("!!7\xDD+e$7\x8E+[%7.+Q%7\x8E+G%7\u0119+=%7\x8E+3%7.+)%4'61'\"$ %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"+\u0111$ #!7\x8E+\x83$7\xCE+y%7\x8E+o%7\xDD+e%7\x8E+[%7.+Q%7\x8E+G%7\u0119+=%7\x8E+3%7.+)%4*61*\"$ %$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \",\x8E&!7\x8E+\x83$7\xCE+y%7\x8E+o%7\xDD+e%7\x8E+[%7.+Q%7\x8E+G%7\u0119+=%7\x8E+3%7.+)%4*61*\"$ %$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"6)\"\"! %$\"# \"\"# \""),
          peg$decode("8!7(+<$7\x8E+2%7\xCF+(%4#63#!\"%$## \"$\"# \"\"# \"*p \"!7(+e$7\x8E+[%7\xCE+Q%7\x8E+G%7.+=%7\x8E+3%7\xCF+)%4'64'\"&\"%$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 32"),
          peg$decode("8!7\xF8+=$7\x8E+3%7*+)%4#66#\"\" %$## \"$\"# \"\"# \"*# \"7\x899*\" 35"),
          peg$decode("!7*+\x8D$ #!7\x8E+A$7\xAC+7%7\x8E+-%7*+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\xAC+7%7\x8E+-%7*+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"67\"\"! %$\"# \"\"# \""),
          peg$decode("!7++\x8D$ #!7\x8E+A$7\xFF+7%7\x8E+-%7++#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\xFF+7%7\x8E+-%7++#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"67\"\"! %$\"# \"\"# \""),
          peg$decode("8!7\xF2+<$7\x8E+2%7.+(%4#69#! %$## \"$\"# \"\"# \"9*\" 38"),
          peg$decode("7%*/ \"7)*) \"7'*# \"7,"),
          peg$decode("87.9*\" 3:"),
          peg$decode("7-*# \"7/"),
          ...
          peg$decode("8!7j+;$7\x8E+1%7k+'%4#6A# %$## \"$\"# \"\"# \"*\xAD \"!7j+P$7\x8E+F%73+<%7\x8E+2%7k+(%4%6B%!\"%$%# \"$$# \"$## \"$\"# \"\"# \"*o \"!7j+d$7\x8E+Z%73+P%7\x8E+F%7`+<%7\x8E+2%7k+(%4'6B'!$%$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3@"),
          peg$decode("!!87\x829*$$\"\" C\"# \"+2$7G+(%4\"6D\"! %$\"# \"\"# \""),
          ...
          peg$decode("!!87\x829*$$\"\" C\"# \"+2$7G+(%4\"6g\"! %$\"# \"\"# \""),
          peg$decode("8!7C+F$!87E*# \"7;9*$$\"\" C\"# \"+(%4\"6i\"!!%$\"# \"\"# \"*Q \"!7A+F$!87E*# \"7;9*$$\"\" C\"# \"+(%4\"6i\"!!%$\"# \"\"# \"9*\" 3h"),
          peg$decode("87\xE4*# \"7\xF59*\" 3j"),
          peg$decode(".k\"\"2k3l"),
          peg$decode("8!7l+D$ #7M,#&7M\"+2%7m+(%4#6n#!!%$## \"$\"# \"\"# \"9*\" 3m"),
          peg$decode("!!87m*) \"7K*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6o\" %$\"# \"\"# \"*C \"!7K+2$7T+(%4\"6p\"! %$\"# \"\"# \"*# \"7S"),
          peg$decode(".q\"\"2q3r"),
          peg$decode(".s\"\"2s3t"),
          peg$decode("8!7N+D$ #7Q,#&7Q\"+2%7N+(%4#6v#!!%$## \"$\"# \"\"# \"*O \"!7O+D$ #7R,#&7R\"+2%7O+(%4#6v#!!%$## \"$\"# \"\"# \"9*\" 3u"),
          peg$decode("!!87N*) \"7K*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6o\" %$\"# \"\"# \"*C \"!7K+2$7T+(%4\"6p\"! %$\"# \"\"# \"*# \"7S"),
          peg$decode("!!87O*) \"7K*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6o\" %$\"# \"\"# \"*C \"!7K+2$7T+(%4\"6p\"! %$\"# \"\"# \"*# \"7S"),
          peg$decode("!7K+1$7\x8D+'%4\"6w\" %$\"# \"\"# \""),
          peg$decode("7U*\\ \"!.S\"\"2S3T+?$!87;9*$$\"\" C\"# \"+'%4\"6x\" %$\"# \"\"# \"*) \"7Y*# \"7Z"),
          peg$decode("7V*# \"7W"),
          peg$decode("7O*\xB3 \"7N*\xAD \"7K*\xA7 \"!.y\"\"2y3z+& 4!6{! %*\x90 \"!.|\"\"2|3}+& 4!6~! %*y \"!.\"\"23\x80+& 4!6\x81! %*b \"!.\x82\"\"2\x823\x83+& 4!6\x84! %*K \"!.\x85\"\"2\x853\x86+& 4!6\x87! %*4 \"!.\x88\"\"2\x883\x89+& 4!6\x8A! %"),
          peg$decode("!!87X*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6o\" %$\"# \"\"# \""),
          peg$decode("7V*; \"7;*5 \".\x8B\"\"2\x8B3\x8C*) \".\x8D\"\"2\x8D3\x8E"),
          peg$decode("!.\x8B\"\"2\x8B3\x8C+M$!!7B+-$7B+#%'\"%$\"# \"\"# \"+! (%+(%4\"6\x8F\"! %$\"# \"\"# \""),
          peg$decode("!.\x8D\"\"2\x8D3\x8E+a$!!7B+A$7B+7%7B+-%7B+#%'$%$$# \"$## \"$\"# \"\"# \"+! (%+(%4\"6\x8F\"! %$\"# \"\"# \""),
          peg$decode("87]*# \"7\\9*\" 3\x90"),
          peg$decode("!7z+{$ #!!87\x8C9*$$\"\" C\"# \"+-$7D+#%'\"%$\"# \"\"# \",F&!!87\x8C9*$$\"\" C\"# \"+-$7D+#%'\"%$\"# \"\"# \"\"+#%'\"%$\"# \"\"# \""),
          peg$decode("!7{+\x85$ #!!87|9*$$\"\" C\"# \"+-$7D+#%'\"%$\"# \"\"# \",F&!!87|9*$$\"\" C\"# \"+-$7D+#%'\"%$\"# \"\"# \"\"+-%7|+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("!7{+\x91$ #!!87|*# \"7\x8C9*$$\"\" C\"# \"+-$7D+#%'\"%$\"# \"\"# \",L&!!87|*# \"7\x8C9*$$\"\" C\"# \"+-$7D+#%'\"%$\"# \"\"# \"\"+-%7|+#%'#%$## \"$\"# \"\"# \""),
          ...
          peg$decode(" #0\xC3\"\"1!3\xC4,)&0\xC3\"\"1!3\xC4\""),
          peg$decode(".\xC5\"\"2\xC53\xC6*# \"7c"),
          peg$decode(".\xC7\"\"2\xC73\xC8"),
          peg$decode(".\xC9\"\"2\xC93\xCA"),
          peg$decode("! #-\"\"1!3b,(&-\"\"1!3b\"+A$!8.\xC9\"\"2\xC93\xCA9+$$\"# C\"\" \"+#%'\"%$\"# \"\"# \""),
          peg$decode(" \xCB"),
          peg$decode("!7\xAC+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0470 \"!7\xAE+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0447 \"!7\xB3+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u041E \"!7\xB4+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u03F5 \"!7\xB8+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u03CC \"!7\xB9+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u03A3 \"!7\xCE+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u037A \"!7\xCF+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0351 \"!7\xD0+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0328 \"!7\xD3+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u02FF \"!7\xD9+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u02D6 \"!7\xDD+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u02AD \"!7\xE1+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0284 \"!7\xEC+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u025B \"!7\xED+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0232 \"!7\xF1+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0209 \"!7\xF4+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u01E0 \"!7\xF8+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u01B7 \"!7\xF9+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u018E \"!7\xFC+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0165 \"!7\xFF+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u013C \"!7\u0102+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0113 \"!7\u0109+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\xEA \"!7\u0114+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\xC1 \"!7\u0119+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\x98 \"!7\u011C+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*o \"!7\u0128+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*F \"!7\u0129+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \""),
          peg$decode("8!7\xFA+& 4!6\xCD! %9*\" 3\xCC"),
          peg$decode("8!7\u011F+& 4!6\xCF! %*. \"!7\xD6+& 4!6\xD0! %9*\" 3\xCE"),
          peg$decode("87*) \"7\x80*# \"7\x819*\" 3\xD1"),
          peg$decode("7e*# \"7d"),
          peg$decode("!7\x9D+\x8D$ #!7\x8E+A$7\x83+7%7\x8E+-%7\x9D+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\x83+7%7\x8E+-%7\x9D+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xD2\"\"! %$\"# \"\"# \""),
          peg$decode("8.\xD4\"\"2\xD43\xD5*) \".\xD6\"\"2\xD63\xD79*\" 3\xD3"),
          peg$decode("!7\x84+\x8D$ #!7\x8E+A$7\x85+7%7\x8E+-%7\x84+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\x85+7%7\x8E+-%7\x84+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xD2\"\"! %$\"# \"\"# \""),
          peg$decode("87q*\x81 \"7r*{ \"!!7o+;$!87o9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"+! (%*L \"!!7p+;$!87p9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"+! (%9*\" 3\xD8"),
          peg$decode("!7\x86+\x8D$ #!7\x8E+A$7\x87+7%7\x8E+-%7\x86+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\x87+7%7\x8E+-%7\x86+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"67\"\"! %$\"# \"\"# \"*# \"7\x96"),
          peg$decode("!7\x88+\x8D$ #!7\x8E+A$7\x8A+7%7\x8E+-%7\x88+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\x8A+7%7\x8E+-%7\x88+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"67\"\"! %$\"# \"\"# \""),
          peg$decode("87u*/ \"7t*) \"7s*# \"7v9*\" 3\xD9"),
          peg$decode("8.\xDB\"\"2\xDB3\xDC*Y \".\xDD\"\"2\xDD3\xDE*M \".\xDF\"\"2\xDF3\xE0*A \".\xE1\"\"2\xE13\xE2*5 \".\xE3\"\"2\xE33\xE4*) \".\xE5\"\"2\xE53\xE69*\" 3\xDA"),
          peg$decode("80\xE8\"\"1!3\xE99*\" 3\xE7"),
          peg$decode("8.\xC1\"\"2\xC13\xC2*M \".\xEB\"\"2\xEB3\xEC*A \".\xED\"\"2\xED3\xEE*5 \".\xEF\"\"2\xEF3\xF0*) \".\xF1\"\"2\xF13\xF29*\" 3\xEA"),
          peg$decode(" #7\x8B*) \"7\x8D*# \"7[,/&7\x8B*) \"7\x8D*# \"7[\""),
          peg$decode(" #7\x8B*# \"7^,)&7\x8B*# \"7^\""),
          peg$decode("87\xED*# \"7\xF99*\" 3\xF3"),
          peg$decode("!7\x99+=$7\x8E+3%7\x90+)%4#6\xF4#\"\" %$## \"$\"# \"\"# \""),
          peg$decode("!7\x99+R$7\x8E+H%7\xEC+>%7\x8E+4%7\x9C+*%4%6\xF5%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x99+g$7\x8E+]%7\xEC+S%7\x8E+I%7\xF8+?%7\x8E+5%7\x9C++%4'6\xF6'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x99+R$7\x8E+H%7\xE1+>%7\x8E+4%7.+*%4%6\xF7%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*\u01E7 \"!7\x99+\xC2$7\x8E+\xB8%7\xE1+\xAE%7\x8E+\xA4%7j+\x9A% #!73+7$7`+-%7\x8E+#%'#%$## \"$\"# \"\"# \"+E$,B&!73+7$7`+-%7\x8E+#%'#%$## \"$\"# \"\"# \"\"\"\" \"*# \" $+=%7\x8E+3%7k+)%4(6\xF8(\"'%%$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\u0137 \"!7\x99+g$7\x8E+]%7\xF8+S%7\x8E+I%7\xE1+?%7\x8E+5%7.++%4'6\xF9'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\xE2 \"!7\x99+\xD7$7\x8E+\xCD%7\xF8+\xC3%7\x8E+\xB9%7\xE1+\xAF%7\x8E+\xA5%7j+\x9B% #!73+7$7`+-%7\x8E+#%'#%$## \"$\"# \"\"# \"+E$,B&!73+7$7`+-%7\x8E+#%'#%$## \"$\"# \"\"# \"\"\"\" \"*# \" $+>%7\x8E+4%7k+*%4*6\xFA*#)'%%$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x99+z$7\x8E+p%7\xB4+f%7\x8E+\\%7\x99+R%7\x8E+H%7\xAC+>%7\x8E+4%7\x99+*%4)6\xFB)#($ %$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\x9A \"!7\x99+\x8F$7\x8E+\x85%7\xF8+{%7\x8E+q%7\xB4+g%7\x8E+]%7\x99+S%7\x8E+I%7\xAC+?%7\x8E+5%7\x99++%4+6\xFC+$*($ %$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("87\xF1*# \"7\xDF9*\" 3\xFD"),
          peg$decode("8!7\x99+{$7\x8E+q%7\x95+g%7\x8E+]%7\x99+S%7\x8E+I%7\xD0+?%7\x8E+5%7P++%4)6\xFE)$(&$ %$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\u0130 \"!7\x99+R$7\x8E+H%7\x95+>%7\x8E+4%7\x99+*%4%6\xFF%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*\xF0 \"!7\x99+\x90$7\x8E+\x86%7\xF8+|%7\x8E+r%7\x95+h%7\x8E+^%7\x99+T%7\x8E+J%7\xD0+@%7\x8E+6%7P+,%4+6\u0100+%*(&$ %$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x99+g$7\x8E+]%7\xF8+S%7\x8E+I%7\x95+?%7\x8E+5%7\x99++%4'6\u0101'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xFD"),
          peg$decode("7\u0109*B \"!7\u0114+7$7\x8E+-%7\u011C+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("8!7\x99+R$7\x8E+H%7\x97+>%7\x8E+4%7\x99+*%4%6\u0103%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x99+g$7\x8E+]%7\xF8+S%7\x8E+I%7\x97+?%7\x8E+5%7\x99++%4'6\u0104'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\u0102"),
          peg$decode("!7:+\xBF$ #!7\x8E+Z$7l+P%7\x8E+F%7.+<%7\x8E+2%7m+(%4&6\u0105&!\"%$&# \"$%# \"$$# \"$## \"$\"# \"\"# \",e&!7\x8E+Z$7l+P%7\x8E+F%7.+<%7\x8E+2%7m+(%4&6\u0105&!\"%$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\u0106\"\"! %$\"# \"\"# \""),
          peg$decode("7\x96*A \"7\x98*; \"7\x94*5 \"7\x93*/ \"7\x91*) \"7\x92*# \"7\x99"),
          peg$decode("87d*) \"7e*# \"7i9*\" 3\u0107"),
          peg$decode("!7\x9B+=$7\x8E+3%7\x9A+)%4#6\u0108#\"\" %$## \"$\"# \"\"# \"*# \"7\x9A"),
          peg$decode("!7\x9C+\x8D$ #!7\x8E+A$7\x9E+7%7\x8E+-%7\x9C+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8E+A$7\x9E+7%7\x8E+-%7\x9C+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xD2\"\"! %$\"# \"\"# \""),
          peg$decode("87f*) \"7g*# \"7h9*\" 3\u0109"),
          peg$decode("! #0\u010A\"\"1!3\u010B+,$,)&0\u010A\"\"1!3\u010B\"\"\" \"+' 4!6\u010C!! %"),
          peg$decode("!!!7H+7$7a+-%7\x9F+#%'#%$## \"$\"# \"\"# \"+' 4!6\u010D!! %*/ \"!7\x9F+' 4!6\u010E!! %+' 4!6\u010F!! %"),
          peg$decode("!.\u0110\"\"2\u01103\u0111+-$7H+#%'\"%$\"# \"\"# \""),
          peg$decode(".\u0112\"\"2\u01123\u0113"),
          peg$decode(".\u0112\"\"2\u01123\u0113"),
          peg$decode(".\u0112\"\"2\u01123\u0113"),
          peg$decode("/\u0114\"\"1%3\u0115"),
          ...
          peg$decode("/\u01DF\"\"1'3\u01E0"),
          peg$decode("/\u01E1\"\"1&3\u01E2"),
          peg$decode("!7\x8E+3$/\u01E3\"\"1'3\u01E4+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01E5\"\"1(3\u01E6"),
          peg$decode("/\u01E7\"\"1(3\u01E8"),
          peg$decode("/\u01E9\"\"1#3\u01EA"),
          peg$decode("/\u01EB\"\"1)3\u01EC"),
          peg$decode("!7\x8E+3$/\u01ED\"\"1&3\u01EE+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01EF\"\"1#3\u01F0"),
          peg$decode("/\u01F1\"\"1'3\u01F2"),
          peg$decode("/\u01F3\"\"1&3\u01F4"),
          peg$decode("/\u01F5\"\"1%3\u01F6"),
