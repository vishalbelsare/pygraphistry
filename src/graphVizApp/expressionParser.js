  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("8!7&+=$7\x8E+3%7.+)%4#60#\"\" %$## \"$\"# \"\"# \"9*\" 3/"),
          ...
          peg$decode("!!87m*) \"7K*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6q\" %$\"# \"\"# \"*C \"!7K+2$7T+(%4\"6r\"! %$\"# \"\"# \"*# \"7S"),
          peg$decode(".s\"\"2s3t"),
          peg$decode(".u\"\"2u3v"),
          peg$decode("8!7N+D$ #7Q,#&7Q\"+2%7N+(%4#6x#!!%$## \"$\"# \"\"# \"*O \"!7O+D$ #7R,#&7R\"+2%7O+(%4#6x#!!%$## \"$\"# \"\"# \"9*\" 3w"),
          peg$decode("!!87N*) \"7K*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6q\" %$\"# \"\"# \"*C \"!7K+2$7T+(%4\"6r\"! %$\"# \"\"# \"*# \"7S"),
          peg$decode("!!87O*) \"7K*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6q\" %$\"# \"\"# \"*C \"!7K+2$7T+(%4\"6r\"! %$\"# \"\"# \"*# \"7S"),
          peg$decode("!7K+1$7\x8D+'%4\"6y\" %$\"# \"\"# \""),
          peg$decode("7U*\\ \"!.S\"\"2S3T+?$!87;9*$$\"\" C\"# \"+'%4\"6z\" %$\"# \"\"# \"*) \"7Y*# \"7Z"),
          peg$decode("7V*# \"7W"),
          ...
          peg$decode("!!87X*# \"7\x8C9*$$\"\" C\"# \"+1$7D+'%4\"6q\" %$\"# \"\"# \""),
          ...
          peg$decode("! #-\"\"1!3b,(&-\"\"1!3b\"+A$!8.\xCB\"\"2\xCB3\xCC9+$$\"# C\"\" \"+#%'\"%$\"# \"\"# \""),
          peg$decode(" \xCD"),
          peg$decode("!7\xAC+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u04C2 \"!7\xAE+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0499 \"!7\xB3+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0470 \"!7\xB4+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0447 \"!7\xB8+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u041E \"!7\xB9+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u03F5 \"!7\xCE+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u03CC \"!7\xCF+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u03A3 \"!7\xD0+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u037A \"!7\xD3+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0351 \"!7\xD9+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0328 \"!7\xDD+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u02FF \"!7\xE1+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u02D6 \"!7\xE4+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u02AD \"!7\xEC+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0284 \"!7\xED+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u025B \"!7\xF1+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0232 \"!7\xF4+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0209 \"!7\xF5+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u01E0 \"!7\xF8+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u01B7 \"!7\xF9+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u018E \"!7\xFC+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0165 \"!7\xFF+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u013C \"!7\u0102+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\u0113 \"!7\u0109+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\xEA \"!7\u0114+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\xC1 \"!7\u0119+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*\x98 \"!7\u011C+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*o \"!7\u0128+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"*F \"!7\u0129+;$!87F9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \""),
          ...
          peg$decode("87q*\x81 \"7r*{ \"!!7o+;$!87o9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"+! (%*L \"!!7p+;$!87p9*$$\"\" C\"# \"+#%'\"%$\"# \"\"# \"+! (%9*\" 3\xDA"),
