  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("!!7,+' 4!6;!! %+\x97$ #!7\x8B+F$7]+<%7\x8B+2%7,+(%4$6;$! %$$# \"$## \"$\"# \"\"# \",Q&!7\x8B+F$7]+<%7\x8B+2%7,+(%4$6;$! %$$# \"$## \"$\"# \"\"# \"\"+)%4\"6<\"\"! %$\"# \"\"# \""),
          peg$decode("!7g+;$7\x8B+1%7h+'%4#6=# %$## \"$\"# \"\"# \"*\xAD \"!7g+P$7\x8B+F%71+<%7\x8B+2%7h+(%4%6>%!\"%$%# \"$$# \"$## \"$\"# \"\"# \"*o \"!7g+d$7\x8B+Z%71+P%7\x8B+F%7]+<%7\x8B+2%7h+(%4'6>'!$%$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!!879*$$\"\" ?\"# \"+2$7D+(%4\"6@\"! %$\"# \"\"# \""),
          peg$decode("8!73+P$7\x8B+F%7g+<%7\x8B+2%7h+(%4%6B%!$%$%# \"$$# \"$## \"$\"# \"\"# \"*p \"!73+e$7\x8B+[%7g+Q%7\x8B+G%71+=%7\x8B+3%7h+)%4'6C'\"&\"%$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3A"),
          peg$decode("87\xC1*) \"7\u0116*# \"7\u01179*\" 3D"),
          peg$decode("8!75+=$7\x8B+3%7,+)%4#6F#\"\" %$## \"$\"# \"\"# \"9*\" 3E"),
          peg$decode("7I* \"7#*y \"76*s \"74*m \"7E*g \"70*a \"!7g+P$7\x8B+F%7-+<%7\x8B+2%7h+(%4%6G%!\"%$%# \"$$# \"$## \"$\"# \"\"# \"*# \"72"),
          peg$decode("0H\"\"1!3I"),
          peg$decode("0J\"\"1!3K"),
          peg$decode("!.L\"\"2L3M+& 4!6N! %*D \"!79+9$ #78,#&78\"+'%4\"6O\" %$\"# \"\"# \""),
          peg$decode("/P\"\"1!3Q"),
          peg$decode("!0R\"\"1!3S*# \" $+<$ #78+&$,#&78\"\"\" \"+#%'\"%$\"# \"\"# \""),
          peg$decode("!7;+-$7<+#%'\"%$\"# \"\"# \""),
          peg$decode("!7:+S$7\\+I% #78,#&78\"+7%7=*# \" $+'%4$6T$ %$$# \"$## \"$\"# \"\"# \"*\x80 \"!7\\+P$ #78+&$,#&78\"\"\" \"+7%7=*# \" $+'%4#6T# %$## \"$\"# \"\"# \"*B \"!7:+7$7=*# \" $+'%4\"6U\" %$\"# \"\"# \""),
          peg$decode("0V\"\"1!3W"),
          peg$decode("!/X\"\"1\"3Y+G$! #7?+&$,#&7?\"\"\" \"+! (%+(%4\"6Z\"! %$\"# \"\"# \""),
          peg$decode("-\"\"1!3["),
          peg$decode("0\\\"\"1!3]"),
          peg$decode("7B*) \"7^*# \"78"),
          peg$decode("8!7B+;$ #7C,#&7C\"+)%4\"6_\"\"! %$\"# \"\"# \"9*\" 3^"),
          peg$decode("!!879*$$\"\" ?\"# \"+2$7D+(%4\"6`\"! %$\"# \"\"# \""),
          peg$decode("8!7@+F$!87B*# \"789*$$\"\" ?\"# \"+(%4\"6b\"!!%$\"# \"\"# \"*Q \"!7>+F$!87B*# \"789*$$\"\" ?\"# \"+(%4\"6b\"!!%$\"# \"\"# \"9*\" 3a"),
          peg$decode("87\xE2*# \"7\xF29*\" 3c"),
          peg$decode(".d\"\"2d3e"),
          peg$decode("8!7i+D$ #7J,#&7J\"+2%7j+(%4#6g#!!%$## \"$\"# \"\"# \"9*\" 3f"),
          peg$decode("!!87j*) \"7H*# \"7\x899*$$\"\" ?\"# \"+1$7A+'%4\"6h\" %$\"# \"\"# \"*C \"!7H+2$7Q+(%4\"6i\"! %$\"# \"\"# \"*# \"7P"),
          peg$decode(".j\"\"2j3k"),
          peg$decode(".l\"\"2l3m"),
          peg$decode("8!7K+D$ #7N,#&7N\"+2%7K+(%4#6o#!!%$## \"$\"# \"\"# \"*O \"!7L+D$ #7O,#&7O\"+2%7L+(%4#6o#!!%$## \"$\"# \"\"# \"9*\" 3n"),
          peg$decode("!!87K*) \"7H*# \"7\x899*$$\"\" ?\"# \"+1$7A+'%4\"6h\" %$\"# \"\"# \"*C \"!7H+2$7Q+(%4\"6i\"! %$\"# \"\"# \"*# \"7P"),
          peg$decode("!!87L*) \"7H*# \"7\x899*$$\"\" ?\"# \"+1$7A+'%4\"6h\" %$\"# \"\"# \"*C \"!7H+2$7Q+(%4\"6i\"! %$\"# \"\"# \"*# \"7P"),
          peg$decode("!7H+1$7\x8A+'%4\"6p\" %$\"# \"\"# \""),
          peg$decode("7R*\\ \"!.L\"\"2L3M+?$!8789*$$\"\" ?\"# \"+'%4\"6q\" %$\"# \"\"# \"*) \"7V*# \"7W"),
          peg$decode("7S*# \"7T"),
          peg$decode("7L*\xB3 \"7K*\xAD \"7H*\xA7 \"!.r\"\"2r3s+& 4!6t! %*\x90 \"!.u\"\"2u3v+& 4!6w! %*y \"!.x\"\"2x3y+& 4!6z! %*b \"!.{\"\"2{3|+& 4!6}! %*K \"!.~\"\"2~3+& 4!6\x80! %*4 \"!.\x81\"\"2\x813\x82+& 4!6\x83! %"),
          peg$decode("!!87U*# \"7\x899*$$\"\" ?\"# \"+1$7A+'%4\"6h\" %$\"# \"\"# \""),
          peg$decode("7S*; \"78*5 \".\x84\"\"2\x843\x85*) \".\x86\"\"2\x863\x87"),
          peg$decode("!.\x84\"\"2\x843\x85+M$!!7?+-$7?+#%'\"%$\"# \"\"# \"+! (%+(%4\"6\x88\"! %$\"# \"\"# \""),
          peg$decode("!.\x86\"\"2\x863\x87+a$!!7?+A$7?+7%7?+-%7?+#%'$%$$# \"$## \"$\"# \"\"# \"+! (%+(%4\"6\x88\"! %$\"# \"\"# \""),
          peg$decode("87Z*# \"7Y9*\" 3\x89"),
          peg$decode("!7w+{$ #!!87\x899*$$\"\" ?\"# \"+-$7A+#%'\"%$\"# \"\"# \",F&!!87\x899*$$\"\" ?\"# \"+-$7A+#%'\"%$\"# \"\"# \"\"+#%'\"%$\"# \"\"# \""),
          peg$decode("!7x+\x85$ #!!87y9*$$\"\" ?\"# \"+-$7A+#%'\"%$\"# \"\"# \",F&!!87y9*$$\"\" ?\"# \"+-$7A+#%'\"%$\"# \"\"# \"\"+-%7y+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("!7x+\x91$ #!!87y*# \"7\x899*$$\"\" ?\"# \"+-$7A+#%'\"%$\"# \"\"# \",L&!!87y*# \"7\x899*$$\"\" ?\"# \"+-$7A+#%'\"%$\"# \"\"# \"\"+-%7y+#%'#%$## \"$\"# \"\"# \""),
          ...
          peg$decode(" #0\xBC\"\"1!3\xBD,)&0\xBC\"\"1!3\xBD\""),
          peg$decode(".\xBE\"\"2\xBE3\xBF*# \"7`"),
          peg$decode(".\xC0\"\"2\xC03\xC1"),
          peg$decode(".\xC2\"\"2\xC23\xC3"),
          peg$decode("! #-\"\"1!3[,(&-\"\"1!3[\"+A$!8.\xC2\"\"2\xC23\xC39+$$\"# ?\"\" \"+#%'\"%$\"# \"\"# \""),
          peg$decode(" \xC4"),
          peg$decode("!7\xAA+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u03A3 \"!7\xAC+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u037A \"!7\xB1+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0351 \"!7\xB2+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0328 \"!7\xB6+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u02FF \"!7\xB7+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u02D6 \"!7\xCC+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u02AD \"!7\xCD+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0284 \"!7\xCE+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u025B \"!7\xD1+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0232 \"!7\xD7+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0209 \"!7\xDB+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u01E0 \"!7\xDF+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u01B7 \"!7\xEA+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u018E \"!7\xEB+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0165 \"!7\xEF+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u013C \"!7\xF5+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\u0113 \"!7\xF6+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\xEA \"!7\xFC+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\xC1 \"!7\u0115+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*\x98 \"!7\u0118+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*o \"!7\u0124+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"*F \"!7\u0125+;$!87C9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \""),
          peg$decode("8!7\xF7+& 4!6\xC6! %9*\" 3\xC5"),
          peg$decode("8!7\u011B+& 4!6\xC8! %*. \"!7\xD4+& 4!6\xC9! %9*\" 3\xC7"),
          peg$decode("87|*) \"7}*# \"7~9*\" 3\xCA"),
          peg$decode("7b*# \"7a"),
          peg$decode("!7\x9B+\x8D$ #!7\x8B+A$7\x80+7%7\x8B+-%7\x9B+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\x80+7%7\x8B+-%7\x9B+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xCB\"\"! %$\"# \"\"# \""),
          peg$decode("8.\xCD\"\"2\xCD3\xCE*) \".\xCF\"\"2\xCF3\xD09*\" 3\xCC"),
          peg$decode("!7\x81+\x8D$ #!7\x8B+A$7\x82+7%7\x8B+-%7\x81+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\x82+7%7\x8B+-%7\x81+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xCB\"\"! %$\"# \"\"# \""),
          peg$decode("87n*\x81 \"7o*{ \"!!7l+;$!87l9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"+! (%*L \"!!7m+;$!87m9*$$\"\" ?\"# \"+#%'\"%$\"# \"\"# \"+! (%9*\" 3\xD1"),
          ...
          peg$decode("87r*/ \"7q*) \"7p*# \"7s9*\" 3\xD2"),
          peg$decode("8.\xD4\"\"2\xD43\xD5*Y \".\xD6\"\"2\xD63\xD7*M \".\xD8\"\"2\xD83\xD9*A \".\xDA\"\"2\xDA3\xDB*5 \".\xDC\"\"2\xDC3\xDD*) \".\xDE\"\"2\xDE3\xDF9*\" 3\xD3"),
          peg$decode("80\xE1\"\"1!3\xE29*\" 3\xE0"),
          peg$decode("8.\xBA\"\"2\xBA3\xBB*M \".\xE4\"\"2\xE43\xE5*A \".\xE6\"\"2\xE63\xE7*5 \".\xE8\"\"2\xE83\xE9*) \".\xEA\"\"2\xEA3\xEB9*\" 3\xE3"),
          peg$decode(" #7\x88*) \"7\x8A*# \"7X,/&7\x88*) \"7\x8A*# \"7X\""),
          peg$decode(" #7\x88*# \"7[,)&7\x88*# \"7[\""),
          peg$decode("87\xEB*# \"7\xF69*\" 3\xEC"),
          peg$decode("!7\x97+=$7\x8B+3%7\x8D+)%4#6\xED#\"\" %$## \"$\"# \"\"# \""),
          peg$decode("!7\x97+R$7\x8B+H%7\xEA+>%7\x8B+4%7\x9A+*%4%6\xEE%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*r \"!7\x97+g$7\x8B+]%7\xEA+S%7\x8B+I%7\xF5+?%7\x8B+5%7\x9A++%4'6\xEF'$&$\" %$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("7\xDF*B \"!7\xF5+7$7\x8B+-%7\xDF+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("!7\x97+R$7\x8B+H%7\x90+>%7\x8B+4%7,+*%4%6\xF0%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"*\xCD \"!7\x97+\xC2$7\x8B+\xB8%7\x90+\xAE%7\x8B+\xA4%7g+\x9A% #!71+7$7]+-%7\x8B+#%'#%$## \"$\"# \"\"# \"+E$,B&!71+7$7]+-%7\x8B+#%'#%$## \"$\"# \"\"# \"\"\"\" \"*# \" $+=%7\x8B+3%7h+)%4(6\xF1(\"'%%$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("!7\x97+z$7\x8B+p%7\xB2+f%7\x8B+\\%7\x97+R%7\x8B+H%7\xAA+>%7\x8B+4%7\x97+*%4)6\xF2)#($ %$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*\x9A \"!7\x97+\x8F$7\x8B+\x85%7\xF5+{%7\x8B+q%7\xB2+g%7\x8B+]%7\x97+S%7\x8B+I%7\xAA+?%7\x8B+5%7\x97++%4+6\xF3+$*($ %$+# \"$*# \"$)# \"$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("87\xEF*m \"7\xDD*g \"!7\xF5+7$7\x8B+-%7\xEF+#%'#%$## \"$\"# \"\"# \"*B \"!7\xF5+7$7\x8B+-%7\xDD+#%'#%$## \"$\"# \"\"# \"9*\" 3\xF4"),
          peg$decode("8!7\x97+q$7\x8B+g%7\x93+]%7\x8B+S%7\x97+I%7\x8B+?%7\xCE+5%7M++%4(6\xF5($'%# %$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"*] \"!7\x97+R$7\x8B+H%7\x93+>%7\x8B+4%7\x97+*%4%6\xF6%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xF4"),
          peg$decode("7\u0105*\xA0 \"!7\u0110+7$7\x8B+-%7\u0118+#%'#%$## \"$\"# \"\"# \"*{ \"!7\xF5+7$7\x8B+-%7\u0105+#%'#%$## \"$\"# \"\"# \"*V \"!7\xF5+K$7\x8B+A%7\u0110+7%7\x8B+-%7\u0118+#%'%%$%# \"$$# \"$## \"$\"# \"\"# \""),
          peg$decode("8!7\x97+R$7\x8B+H%7\x95+>%7\x8B+4%7\x97+*%4%6\xF8%#$\" %$%# \"$$# \"$## \"$\"# \"\"# \"9*\" 3\xF7"),
          peg$decode("!77+\xBF$ #!7\x8B+Z$7i+P%7\x8B+F%7,+<%7\x8B+2%7j+(%4&6\xF9&!\"%$&# \"$%# \"$$# \"$## \"$\"# \"\"# \",e&!7\x8B+Z$7i+P%7\x8B+F%7,+<%7\x8B+2%7j+(%4&6\xF9&!\"%$&# \"$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xFA\"\"! %$\"# \"\"# \""),
          peg$decode("7\x94*A \"7\x96*; \"7\x92*5 \"7\x91*/ \"7\x8E*) \"7\x8F*# \"7\x97"),
          peg$decode("87a*) \"7b*# \"7f9*\" 3\xFB"),
          peg$decode("!7\x99+=$7\x8B+3%7\x98+)%4#6\xFC#\"\" %$## \"$\"# \"\"# \"*# \"7\x98"),
          peg$decode("!7\x9A+\x8D$ #!7\x8B+A$7\x9C+7%7\x8B+-%7\x9A+#%'$%$$# \"$## \"$\"# \"\"# \",L&!7\x8B+A$7\x9C+7%7\x8B+-%7\x9A+#%'$%$$# \"$## \"$\"# \"\"# \"\"+)%4\"6\xCB\"\"! %$\"# \"\"# \""),
          peg$decode("87c*) \"7d*# \"7e9*\" 3\xFD"),
          peg$decode("! #0\xFE\"\"1!3\xFF+,$,)&0\xFE\"\"1!3\xFF\"\"\" \"+' 4!6\u0100!! %"),
          peg$decode("!!!7E+7$7^+-%7\x9D+#%'#%$## \"$\"# \"\"# \"+' 4!6\u0101!! %*/ \"!7\x9D+' 4!6\u0102!! %+' 4!6\u0103!! %"),
          peg$decode("!.\u0104\"\"2\u01043\u0105+-$7E+#%'\"%$\"# \"\"# \""),
          peg$decode(".\u0106\"\"2\u01063\u0107"),
          peg$decode(".\u0106\"\"2\u01063\u0107"),
          peg$decode(".\u0106\"\"2\u01063\u0107"),
          peg$decode("/\u0108\"\"1%3\u0109"),
          ...
          peg$decode("/\u01CF\"\"1'3\u01D0"),
          peg$decode("/\u01D1\"\"1&3\u01D2"),
          peg$decode("!7\x8B+3$/\u01D3\"\"1'3\u01D4+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01D5\"\"1(3\u01D6"),
          peg$decode("/\u01D7\"\"1(3\u01D8"),
          peg$decode("/\u01D9\"\"1#3\u01DA"),
          peg$decode("/\u01DB\"\"1)3\u01DC"),
          peg$decode("!7\x8B+3$/\u01DD\"\"1&3\u01DE+#%'\"%$\"# \"\"# \""),
          peg$decode("/\u01DF\"\"1#3\u01E0"),
          peg$decode("/\u01E1\"\"1'3\u01E2"),
          peg$decode("/\u01E3\"\"1&3\u01E4"),
          peg$decode("/\u01E5\"\"1%3\u01E6"),
