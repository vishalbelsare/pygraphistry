  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("!73+-$74+#%'\"%$\"# !\"# !"),
          peg$decode("!72+S$7O+I% \"70,#&70\"+7%75*# \" #+'%4$6C$ %$$# !$## !$\"# !\"# !*\x80 \"!7O+P$ \"70+&$,#&70\"\"\" !+7%75*# \" #+'%4#6C# %$## !$\"# !\"# !*B \"!72+7$75*# \" #+'%4\"6D\" %$\"# !\"# !"),
          peg$decode("0E\"\"1!3F"),
          ...
          peg$decode("!!87r9*$$\"\" O\"# !+2$7<+(%4\"6P\"! %$\"# !\"# !"),
          peg$decode("8!78+F$!87:*# \"709*$$\"\" O\"# !+(%4\"6R\"!!%$\"# !\"# !*Q \"!76+F$!87:*# \"709*$$\"\" O\"# !+(%4\"6R\"!!%$\"# !\"# !9*\" 3Q"),
          peg$decode("8!.T\"\"2T3U+J$ \"7A,#&7A\"+8%.T\"\"2T3U+(%4#6V#!!%$## !$\"# !\"# !*[ \"!.W\"\"2W3X+J$ \"7B,#&7B\"+8%.W\"\"2W3X+(%4#6V#!!%$## !$\"# !\"# !9*\" 3S"),
          peg$decode(".Y\"\"2Y3Z"),
          peg$decode("!!8.T\"\"2T3U*) \"7@*# \"7|9*$$\"\" O\"# !+1$79+'%4\"6[\" %$\"# !\"# !*I \"!.Y\"\"2Y3Z+2$7D+(%4\"6\\\"! %$\"# !\"# !*# \"7C"),
          peg$decode("!!8.W\"\"2W3X*) \"7@*# \"7|9*$$\"\" O\"# !+1$79+'%4\"6[\" %$\"# !\"# !*C \"!7@+2$7D+(%4\"6\\\"! %$\"# !\"# !*# \"7C"),
          peg$decode("!7@+1$7}+'%4\"6]\" %$\"# !\"# !"),
          peg$decode("7E*\\ \"!.;\"\"2;3<+?$!8709*$$\"\" O\"# !+'%4\"6^\" %$\"# !\"# !*) \"7I*# \"7J"),
          peg$decode("7F*# \"7G"),
          peg$decode(".W\"\"2W3X*\xB9 \".T\"\"2T3U*\xAD \"7@*\xA7 \"!._\"\"2_3`+& 4!6a! %*\x90 \"!.b\"\"2b3c+& 4!6d! %*y \"!.e\"\"2e3f+& 4!6g! %*b \"!.h\"\"2h3i+& 4!6j! %*K \"!.k\"\"2k3l+& 4!6m! %*4 \"!.n\"\"2n3o+& 4!6p! %"),
          peg$decode("!!87H*# \"7|9*$$\"\" O\"# !+1$79+'%4\"6[\" %$\"# !\"# !"),
          peg$decode("7F*; \"70*5 \".q\"\"2q3r*) \".s\"\"2s3t"),
          peg$decode("!.q\"\"2q3r+M$!!77+-$77+#%'\"%$\"# !\"# !+! (%+(%4\"6u\"! %$\"# !\"# !"),
          peg$decode("!.s\"\"2s3t+a$!!77+A$77+7%77+-%77+#%'$%$$# !$## !$\"# !\"# !+! (%+(%4\"6u\"! %$\"# !\"# !"),
          peg$decode("87M*# \"7L9*\" 3v"),
          peg$decode("!7j+{$ \"!!87|9*$$\"\" O\"# !+-$79+#%'\"%$\"# !\"# !,F&!!87|9*$$\"\" O\"# !+-$79+#%'\"%$\"# !\"# !\"+#%'\"%$\"# !\"# !"),
          peg$decode("!7k+\x85$ \"!!87l9*$$\"\" O\"# !+-$79+#%'\"%$\"# !\"# !,F&!!87l9*$$\"\" O\"# !+-$79+#%'\"%$\"# !\"# !\"+-%7l+#%'#%$## !$\"# !\"# !"),
          peg$decode("!7k+\x91$ \"!!87l*# \"7|9*$$\"\" O\"# !+-$79+#%'\"%$\"# !\"# !,L&!!87l*# \"7|9*$$\"\" O\"# !+-$79+#%'\"%$\"# !\"# !\"+-%7l+#%'#%$## !$\"# !\"# !"),
          peg$decode(".w\"\"2w3x"),
          peg$decode(".y\"\"2y3z"),
          peg$decode(".{\"\"2{3|"),
          peg$decode(".}\"\"2}3~"),
          ...
          peg$decode(" \"0\xA9\"\"1!3\xAA,)&0\xA9\"\"1!3\xAA\""),
          peg$decode(".\xAB\"\"2\xAB3\xAC*# \"7S"),
          peg$decode(".\xAD\"\"2\xAD3\xAE"),
          peg$decode(".\xAF\"\"2\xAF3\xB0"),
          peg$decode("! \"-\"\"1!3J,(&-\"\"1!3J\"+A$!8.\xAF\"\"2\xAF3\xB09+$$\"# O\"\" !+#%'\"%$\"# !\"# !"),
          peg$decode(" \xB1"),
          ...
          peg$decode("8!7\xE4+& 4!6\xB3! %9*\" 3\xB2"),
          peg$decode("8!7\u0104+& 4!6\xB5! %*. \"!7\xC4+& 4!6\xB6! %9*\" 3\xB4"),
          peg$decode("87o*) \"7p*# \"7q9*\" 3\xB7"),
          peg$decode("7U*# \"7T"),
          peg$decode("!7\x8E+\x8D$ \"!7~+A$7s+7%7~+-%7\x8E+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7s+7%7~+-%7\x8E+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("8.\xB9\"\"2\xB93\xBA*) \".\xBB\"\"2\xBB3\xBC9*\" 3\xB8"),
          peg$decode("!7t+\x8D$ \"!7~+A$7u+7%7~+-%7t+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7u+7%7~+-%7t+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("87a*\x81 \"7b*{ \"!!7_+;$!87_9*$$\"\" O\"# !+#%'\"%$\"# !\"# !+! (%*L \"!!7`+;$!87`9*$$\"\" O\"# !+#%'\"%$\"# !\"# !+! (%9*\" 3\xBD"),
          peg$decode("!7v+\x8D$ \"!7~+A$7w+7%7~+-%7v+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7w+7%7~+-%7v+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !*# \"7\x86"),
          peg$decode("!7x+\x8D$ \"!7~+A$7z+7%7~+-%7x+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7z+7%7~+-%7x+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("87e*5 \"7c*/ \"7d*) \"7e*# \"7f9*\" 3\xBE"),
          peg$decode("8.\xC0\"\"2\xC03\xC1*Y \".\xC2\"\"2\xC23\xC3*M \".\xC4\"\"2\xC43\xC5*A \".\xC6\"\"2\xC63\xC7*5 \".\xC8\"\"2\xC83\xC9*) \".\xCA\"\"2\xCA3\xCB9*\" 3\xBF"),
          peg$decode("80\xCD\"\"1!3\xCE9*\" 3\xCC"),
          peg$decode("8.\xA7\"\"2\xA73\xA8*M \".\xD0\"\"2\xD03\xD1*A \".\xD2\"\"2\xD23\xD3*5 \".\xD4\"\"2\xD43\xD5*) \".\xD6\"\"2\xD63\xD79*\" 3\xCF"),
          peg$decode(" \"7{*) \"7}*# \"7K,/&7{*) \"7}*# \"7K\""),
          peg$decode(" \"7{*# \"7N,)&7{*# \"7N\""),
          peg$decode("87\xD9*# \"7\xE39*\" 3\xD8"),
          peg$decode("!7\x8A+=$7~+3%7\x80+)%4#6\xD9#\"\" %$## !$\"# !\"# !"),
          peg$decode("!7\x8A+R$7~+H%7\xD8+>%7~+4%7\x8D+*%4%6\xDA%#$\" %$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("!7\x8A+R$7~+H%7\xCF+>%7~+4%7(+*%4%6\xDB%#$\" %$%# !$$# !$## !$\"# !\"# !*\xCD \"!7\x8A+\xC2$7~+\xB8%7\xCF+\xAE%7~+\xA4%7Z+\x9A% \"!7\x8A+7$7P+-%7~+#%'#%$## !$\"# !\"# !+E$,B&!7\x8A+7$7P+-%7~+#%'#%$## !$\"# !\"# !\"\"\" !*# \" #+=%7~+3%7[+)%4(6\xDC(\"'%%$(# !$'# !$&# !$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("!7\x8A+z$7~+p%7\xA4+f%7~+\\%7\x8A+R%7~+H%7\x9D+>%7~+4%7\x8A+*%4)6\xDD)#($ %$)# !$(# !$'# !$&# !$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("87\xDD*# \"7\xCD9*\" 3\xDE"),
          peg$decode("8!7\x8A+R$7~+H%7\x85+>%7~+4%7\x8A+*%4%6\xDF%#$\" %$%# !$$# !$## !$\"# !\"# !9*\" 3\xDE"),
          peg$decode("7\xF1*B \"!7\xFC+7$7~+-%7\u0101+#%'#%$## !$\"# !\"# !"),
          peg$decode("8!7\x8A+R$7~+H%7\x87+>%7~+4%7\x8A+*%4%6\xE1%#$\" %$%# !$$# !$## !$\"# !\"# !9*\" 3\xE0"),
          peg$decode("8!7\xE2+=$7~+3%7\x8B+)%4#6\xE3#\"\" %$## !$\"# !\"# !9*\" 3\xE2"),
          peg$decode("!7/+\xBF$ \"!7~+Z$7\\+P%7~+F%7(+<%7~+2%7]+(%4&6\xE4&!\"%$&# !$%# !$$# !$## !$\"# !\"# !,e&!7~+Z$7\\+P%7~+F%7(+<%7~+2%7]+(%4&6\xE4&!\"%$&# !$%# !$$# !$## !$\"# !\"# !\"+)%4\"6\xE5\"\"! %$\"# !\"# !"),
          peg$decode("7\x89*G \"7\x86*A \"7\x88*; \"7\x84*5 \"7\x83*/ \"7\x81*) \"7\x82*# \"7\x8A"),
          peg$decode("87T*) \"7U*# \"7Y9*\" 3\xE6"),
          peg$decode("!7\x8C+=$7~+3%7\x8B+)%4#6\xE7#\"\" %$## !$\"# !\"# !*# \"7\x8B"),
          peg$decode("!7\x8D+\x8D$ \"!7~+A$7\x8F+7%7~+-%7\x8D+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7\x8F+7%7~+-%7\x8D+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("87V*) \"7W*# \"7X9*\" 3\xE8"),
          peg$decode("! \"0\xE9\"\"1!3\xEA+,$,)&0\xE9\"\"1!3\xEA\"\"\" !+' 4!6\xEB!! %"),
          peg$decode("!!!7=+7$7Q+-%7\x90+#%'#%$## !$\"# !\"# !+' 4!6\xEC!! %*/ \"!7\x90+' 4!6\xED!! %+' 4!6\xEE!! %"),
          peg$decode("!.\xEF\"\"2\xEF3\xF0+-$7=+#%'\"%$\"# !\"# !"),
          ...
          peg$decode("/\u0121\"\"1(3\u0122"),
          peg$decode("/\u0123\"\"1*3\u0124"),
          peg$decode("!7~+3$/\u0125\"\"1&3\u0126+#%'\"%$\"# !\"# !"),
          peg$decode("/\u0127\"\"1%3\u0128"),
          peg$decode("/\u0129\"\"1(3\u012A"),
          peg$decode("/\u012B\"\"1'3\u012C"),
          peg$decode("/\u012D\"\"1*3\u012E"),
          peg$decode("/\u012F\"\"1(3\u0130"),
          peg$decode("!7~+3$/\u0131\"\"1&3\u0132+#%'\"%$\"# !\"# !"),
          peg$decode("/\u0133\"\"1$3\u0134"),
          peg$decode("/\u0135\"\"1&3\u0136"),
          peg$decode("/\u0137\"\"1(3\u0138"),
          peg$decode("/\u0139\"\"1$3\u013A"),
          ...
          peg$decode("/\u01AC\"\"1'3\u01AD"),
          peg$decode("/\u01AE\"\"1&3\u01AF"),
          peg$decode("!7~+3$/\u01B0\"\"1'3\u01B1+#%'\"%$\"# !\"# !"),
          peg$decode("/\u01B2\"\"1(3\u01B3"),
          peg$decode("/\u01B4\"\"1(3\u01B5"),
          peg$decode("/\u01B6\"\"1#3\u01B7"),
          peg$decode("/\u01B8\"\"1)3\u01B9"),
          peg$decode("!7~+3$/\u01BA\"\"1&3\u01BB+#%'\"%$\"# !\"# !"),
          peg$decode("/\u01BC\"\"1#3\u01BD"),
          peg$decode("/\u01BE\"\"1'3\u01BF"),
          peg$decode("/\u01C0\"\"1%3\u01C1"),
          peg$decode("/\u01C2\"\"1$3\u01C3"),
