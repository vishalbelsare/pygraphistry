  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("8.\xBC\"\"2\xBC3\xBD*M \".\xBE\"\"2\xBE3\xBF*A \".\x9E\"\"2\x9E3\x9F*5 \".\xA0\"\"2\xA03\xA1*) \".\xA2\"\"2\xA23\xA39*\" 3\xBB"),
          ...
          peg$decode("8.\xA4\"\"2\xA43\xA5*M \".\xD1\"\"2\xD13\xD2*A \".\xD3\"\"2\xD33\xD4*5 \".\xD5\"\"2\xD53\xD6*) \".\xD7\"\"2\xD73\xD89*\" 3\xD0"),
          peg$decode(" \"7{*) \"7}*# \"7K,/&7{*) \"7}*# \"7K\""),
          peg$decode(" \"7{*# \"7N,)&7{*# \"7N\""),
          peg$decode("87\xD9*# \"7\xE39*\" 3\xD9"),
          peg$decode("!7\x8A+=$7~+3%7\x80+)%4#6\xDA#\"\" %$## !$\"# !\"# !"),
          peg$decode("!7\x8A+R$7~+H%7\xD8+>%7~+4%7\x8D+*%4%6\xDB%#$\" %$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("!7\x8A+R$7~+H%7\xCF+>%7~+4%7(+*%4%6\xDC%#$\" %$%# !$$# !$## !$\"# !\"# !*\xCD \"!7\x8A+\xC2$7~+\xB8%7\xCF+\xAE%7~+\xA4%7Z+\x9A% \"!7\x8A+7$7P+-%7~+#%'#%$## !$\"# !\"# !+E$,B&!7\x8A+7$7P+-%7~+#%'#%$## !$\"# !\"# !\"\"\" !*# \" #+=%7~+3%7[+)%4(6\xDD(\"'%%$(# !$'# !$&# !$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("!7\x8A+z$7~+p%7\xA4+f%7~+\\%7\x8A+R%7~+H%7\x9D+>%7~+4%7\x8A+*%4)6\xDE)#($ %$)# !$(# !$'# !$&# !$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("87\xDD*# \"7\xCD9*\" 3\xDF"),
          peg$decode("8!7\x8A+R$7~+H%7\x85+>%7~+4%7\x8A+*%4%6\xE0%#$\" %$%# !$$# !$## !$\"# !\"# !9*\" 3\xDF"),
          peg$decode("7\xF1*B \"!7\xFC+7$7~+-%7\u0101+#%'#%$## !$\"# !\"# !"),
          peg$decode("8!7\x8A+R$7~+H%7\x87+>%7~+4%7\x8A+*%4%6\xE2%#$\" %$%# !$$# !$## !$\"# !\"# !9*\" 3\xE1"),
          peg$decode("8!7\xE2+=$7~+3%7\x8B+)%4#6\xE4#\"\" %$## !$\"# !\"# !9*\" 3\xE3"),
          peg$decode("!7/+\xBF$ \"!7~+Z$7\\+P%7~+F%7(+<%7~+2%7]+(%4&6\xE5&!\"%$&# !$%# !$$# !$## !$\"# !\"# !,e&!7~+Z$7\\+P%7~+F%7(+<%7~+2%7]+(%4&6\xE5&!\"%$&# !$%# !$$# !$## !$\"# !\"# !\"+)%4\"6\xE6\"\"! %$\"# !\"# !"),
          peg$decode("7\x89*G \"7\x86*A \"7\x88*; \"7\x84*5 \"7\x83*/ \"7\x81*) \"7\x82*# \"7\x8A"),
          peg$decode("87T*) \"7U*# \"7Y9*\" 3\xE7"),
          peg$decode("!7\x8C+=$7~+3%7\x8B+)%4#6\xE8#\"\" %$## !$\"# !\"# !*# \"7\x8B"),
          peg$decode("!7\x8D+\x8D$ \"!7~+A$7\x8F+7%7~+-%7\x8D+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7\x8F+7%7~+-%7\x8D+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("87V*) \"7W*# \"7X9*\" 3\xE9"),
          peg$decode("! \"0\xEA\"\"1!3\xEB+,$,)&0\xEA\"\"1!3\xEB\"\"\" !+' 4!6\xEC!! %"),
          peg$decode("!!!7=+7$7Q+-%7\x90+#%'#%$## !$\"# !\"# !+' 4!6\xED!! %*/ \"!7\x90+' 4!6\xEE!! %+' 4!6\xEF!! %"),
          peg$decode("!.\xF0\"\"2\xF03\xF1+-$7=+#%'\"%$\"# !\"# !"),
          ...
          peg$decode("/\u0122\"\"1(3\u0123"),
          peg$decode("/\u0124\"\"1*3\u0125"),
          peg$decode("!7~+3$/\u0126\"\"1&3\u0127+#%'\"%$\"# !\"# !"),
          peg$decode("/\u0128\"\"1%3\u0129"),
          peg$decode("/\u012A\"\"1(3\u012B"),
          peg$decode("/\u012C\"\"1'3\u012D"),
          peg$decode("/\u012E\"\"1*3\u012F"),
          peg$decode("/\u0130\"\"1(3\u0131"),
          peg$decode("!7~+3$/\u0132\"\"1&3\u0133+#%'\"%$\"# !\"# !"),
          peg$decode("/\u0134\"\"1$3\u0135"),
          peg$decode("/\u0136\"\"1&3\u0137"),
          peg$decode("/\u0138\"\"1(3\u0139"),
          peg$decode("/\u013A\"\"1$3\u013B"),
