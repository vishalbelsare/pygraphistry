  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("!!7{+\u0149$!7*+' 4!6&!! %*\u012D \"!7\x8F+' 4!6'!! %*\u011B \"!!7=+7$7O+-%7\x8D+#%'#%$## !$\"# !\"# !+' 4!6(!! %*\xEA \"!7\x8D+' 4!6)!! %*\xD8 \"!7\xA4+\xCD$7(*# \" #+\xBD% \"!7\u010A+A$7(+7%7\xFD+-%7(+#%'$%$$# !$## !$\"# !\"# !+O$,L&!7\u010A+A$7(+7%7\xFD+-%7(+#%'$%$$# !$## !$\"# !\"# !\"\"\" !+R%!7\xB9+-$7(+#%'\"%$\"# !\"# !*# \" #+-%7\xBA+#%'%%$%# !$$# !$## !$\"# !\"# !+#%'\"%$\"# !\"# !+' 4!6*!! %"),
          peg$decode("!7\xDF+=$7{+3%7$+)%4#6+#\"\" %$## !$\"# !\"# !*# \"7u"),
          peg$decode("!7$+\x8D$ \"!7{+A$7\x9A+7%7{+-%7$+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7\x9A+7%7{+-%7$+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !"),
          peg$decode("!7%+\x8D$ \"!7{+A$7\xE5+7%7{+-%7%+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7\xE5+7%7{+-%7%+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !"),
          peg$decode("!7\xDB+<$7{+2%7>+(%4#6-#! %$## !$\"# !\"# !"),
          peg$decode("7'*# \"7&"),
          peg$decode("87\x90*) \"7\x91*# \"7\x929*\" 3."),
          peg$decode("87>*; \"7?*5 \"7?*/ \"7m*) \"7n*# \"7)9*\" 3/"),
          ...
          peg$decode(".X\"\"2X3Y"),
          peg$decode("!!8.S\"\"2S3T*) \"7@*# \"7y9*$$\"\" N\"# !+1$79+'%4\"6Z\" %$\"# !\"# !*I \"!.X\"\"2X3Y+2$7D+(%4\"6[\"! %$\"# !\"# !*# \"7C"),
          peg$decode("!!8.V\"\"2V3W*) \"7@*# \"7y9*$$\"\" N\"# !+1$79+'%4\"6Z\" %$\"# !\"# !*C \"!7@+2$7D+(%4\"6[\"! %$\"# !\"# !*# \"7C"),
          peg$decode("!7@+1$7z+'%4\"6\\\" %$\"# !\"# !"),
          ...
          peg$decode("!!87H*# \"7y9*$$\"\" N\"# !+1$79+'%4\"6Z\" %$\"# !\"# !"),
          ...
          peg$decode("!7S+{$ \"!!87y9*$$\"\" N\"# !+-$79+#%'\"%$\"# !\"# !,F&!!87y9*$$\"\" N\"# !+-$79+#%'\"%$\"# !\"# !\"+#%'\"%$\"# !\"# !"),
          peg$decode("!7h+\x85$ \"!!87i9*$$\"\" N\"# !+-$79+#%'\"%$\"# !\"# !,F&!!87i9*$$\"\" N\"# !+-$79+#%'\"%$\"# !\"# !\"+-%7i+#%'#%$## !$\"# !\"# !"),
          peg$decode("!7h+\x91$ \"!!87i*# \"7y9*$$\"\" N\"# !+-$79+#%'\"%$\"# !\"# !,L&!!87i*# \"7y9*$$\"\" N\"# !+-$79+#%'\"%$\"# !\"# !\"+-%7i+#%'#%$## !$\"# !\"# !"),
          peg$decode(".v\"\"2v3w"),
          peg$decode(".x\"\"2x3y"),
          peg$decode(".z\"\"2z3{"),
          peg$decode(".|\"\"2|3}"),
          ...
          peg$decode("! \"-\"\"1!3I,(&-\"\"1!3I\"+A$!8.\xA8\"\"2\xA83\xA99+$$\"# N\"\" !+#%'\"%$\"# !\"# !"),
          peg$decode(" \xAA"),
          ...
          peg$decode("8!7\xE1+& 4!6\xAC! %9*\" 3\xAB"),
          peg$decode("8!7\u0101+& 4!6\xAE! %*. \"!7\xC1+& 4!6\xAF! %9*\" 3\xAD"),
          peg$decode("87l*) \"7m*# \"7n9*\" 3\xB0"),
          peg$decode("7U*# \"7T"),
          peg$decode("!7\x89+\x8D$ \"!7{+A$7p+7%7{+-%7\x89+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7p+7%7{+-%7\x89+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !"),
          peg$decode("8.\xB2\"\"2\xB23\xB3*) \".\xB4\"\"2\xB43\xB59*\" 3\xB1"),
          peg$decode("!7q+\x8D$ \"!7{+A$7r+7%7{+-%7q+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7r+7%7{+-%7q+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !"),
          peg$decode("87_*\x81 \"7`*{ \"!!7]+;$!87]9*$$\"\" N\"# !+#%'\"%$\"# !\"# !+! (%*L \"!!7^+;$!87^9*$$\"\" N\"# !+#%'\"%$\"# !\"# !+! (%9*\" 3\xB6"),
          peg$decode("!7s+\x8D$ \"!7{+A$7t+7%7{+-%7s+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7t+7%7{+-%7s+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !*# \"7\x83"),
          peg$decode("!7u+\x8D$ \"!7{+A$7w+7%7{+-%7u+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7w+7%7{+-%7u+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !"),
          peg$decode("8.\xB8\"\"2\xB83\xB9*M \".\xBA\"\"2\xBA3\xBB*A \".\x9C\"\"2\x9C3\x9D*5 \".\x9E\"\"2\x9E3\x9F*) \".\xA0\"\"2\xA03\xA19*\" 3\xB7"),
          ...
          peg$decode("8.\xA2\"\"2\xA23\xA3*M \".\xCD\"\"2\xCD3\xCE*A \".\xCF\"\"2\xCF3\xD0*5 \".\xD1\"\"2\xD13\xD2*) \".\xD3\"\"2\xD33\xD49*\" 3\xCC"),
          peg$decode(" \"7x*) \"7z*# \"7K,/&7x*) \"7z*# \"7K\""),
          peg$decode(" \"7x*# \"7N,)&7x*# \"7N\""),
          peg$decode("87\xD6*# \"7\xE09*\" 3\xD5"),
          peg$decode("!7/+=$7{+3%7}+)%4#6\xD6#\"\" %$## !$\"# !\"# !*# \"7/"),
          peg$decode("!7/+R$7{+H%7\xD5+>%7{+4%7/+*%4%6\xD7%#$\" %$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("!7/+R$7{+H%7\xCC+>%7{+4%7(+*%4%6\xD8%#$\" %$%# !$$# !$## !$\"# !\"# !*\xCD \"!7/+\xC2$7{+\xB8%7\xCC+\xAE%7{+\xA4%7Z+\x9A% \"!7/+7$7P+-%7{+#%'#%$## !$\"# !\"# !+E$,B&!7/+7$7P+-%7{+#%'#%$## !$\"# !\"# !\"\"\" !*# \" #+=%7{+3%7[+)%4(6\xD9(\"'%%$(# !$'# !$&# !$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("!7/+z$7{+p%7\xA1+f%7{+\\%7/+R%7{+H%7\x9A+>%7{+4%7/+*%4)6\xDA)#($ %$)# !$(# !$'# !$&# !$%# !$$# !$## !$\"# !\"# !"),
          peg$decode("87\xDA*) \"7\xCA*# \"7\xF99*\" 3\xDB"),
          peg$decode("8!7/+^$7{+T%7\xDA*) \"7\xCA*# \"7\xF9+>%7{+4%7/+*%4%6\xDC%#$\" %$%# !$$# !$## !$\"# !\"# !9*\" 3\xDB"),
          peg$decode("8!7/+R$7{+H%7\xEE+>%7{+4%7/+*%4%6\xDE%#$\" %$%# !$$# !$## !$\"# !\"# !9*\" 3\xDD"),
          peg$decode("8!7{+G$7\xDF+=%7{+3%7\x86+)%4$6\xE0$\"\" %$$# !$## !$\"# !\"# !9*\" 3\xDF"),
          peg$decode("7\x85*; \"7\x83*5 \"7\x81*/ \"7\x80*) \"7~*# \"7"),
          peg$decode("87T*/ \"7U*) \"7Y*# \"7\xDF9*\" 3\xE1"),
          peg$decode("7\x86*H \"!7\x87+=$7{+3%7\x88+)%4#6\xE2#\"\" %$## !$\"# !\"# !"),
          peg$decode("!7\x88+\x8D$ \"!7{+A$7\x8A+7%7{+-%7\x88+#%'$%$$# !$## !$\"# !\"# !,L&!7{+A$7\x8A+7%7{+-%7\x88+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6,\"\"! %$\"# !\"# !"),
          peg$decode("87V*) \"7W*# \"7X9*\" 3\xE3"),
          peg$decode("!!7{+\u0147$7\\*\u0137 \"7V*\u0131 \"7W*\u012B \"7X*\u0125 \"7U*\u011F \"7T*\u0119 \".\xB2\"\"2\xB23\xB3*\u010D \".\xB4\"\"2\xB43\xB5*\u0101 \".\xE4\"\"2\xE43\xE5*\xF5 \".\xE6\"\"2\xE63\xE7*\xE9 \".\x96\"\"2\x963\x97*\xDD \".\x98\"\"2\x983\x99*\xD1 \".\x92\"\"2\x923\x93*\xC5 \".\x94\"\"2\x943\x95*\xB9 \".\x9A\"\"2\x9A3\x9B*\xAD \".\x9C\"\"2\x9C3\x9D*\xA1 \".\x9E\"\"2\x9E3\x9F*\x95 \".\xA0\"\"2\xA03\xA1*\x89 \"/\xE8\"\"1\"3\xE9*} \"/\xEA\"\"1&3\xEB*q \"/\xEC\"\"1\"3\xED*e \"/\xEE\"\"1$3\xEF*Y \"/\xF0\"\"1$3\xF1*M \"/\xF2\"\"1%3\xF3*A \"/\xF4\"\"1&3\xF5*5 \"/\xF6\"\"1#3\xF7*) \"/\xF8\"\"1\"3\xF9+#%'\"%$\"# !\"# !+' 4!6\xFA!! %"),
          peg$decode("!!7{+\x93$/\xE8\"\"1\"3\xE9*} \"/\xEA\"\"1&3\xEB*q \"/\xEC\"\"1\"3\xED*e \"/\xEE\"\"1$3\xEF*Y \"/\xF0\"\"1$3\xF1*M \"/\xF2\"\"1%3\xF3*A \"/\xF4\"\"1&3\xF5*5 \"/\xF6\"\"1#3\xF7*) \"/\xF8\"\"1\"3\xF9+#%'\"%$\"# !\"# !+' 4!6\xFA!! %"),
          peg$decode("! \"0\xFB\"\"1!3\xFC+,$,)&0\xFB\"\"1!3\xFC\"\"\" !+' 4!6\xFD!! %"),
          peg$decode("!!!7=+7$7Q+-%7\x8D+#%'#%$## !$\"# !\"# !+' 4!6\xFE!! %*/ \"!7\x8D+' 4!6)!! %+' 4!6\xFF!! %"),
          peg$decode("!.\u0100\"\"2\u01003\u0101+-$7=+#%'\"%$\"# !\"# !"),
          peg$decode(".\u0102\"\"2\u01023\u0103"),
          peg$decode(".\u0102\"\"2\u01023\u0103"),
          peg$decode(".\u0102\"\"2\u01023\u0103"),
          ...
          peg$decode("/\u0130\"\"1(3\u0131"),
          peg$decode("/\u0132\"\"1*3\u0133"),
          peg$decode("!7{+3$/\u0134\"\"1&3\u0135+#%'\"%$\"# !\"# !"),
          peg$decode("/\u0136\"\"1%3\u0137"),
          peg$decode("/\u0138\"\"1(3\u0139"),
          peg$decode("/\u013A\"\"1'3\u013B"),
          peg$decode("/\u013C\"\"1*3\u013D"),
          peg$decode("/\u013E\"\"1(3\u013F"),
          peg$decode("!7{+3$/\u0140\"\"1&3\u0141+#%'\"%$\"# !\"# !"),
          peg$decode("/\u0142\"\"1$3\u0143"),
          peg$decode("/\u0144\"\"1&3\u0145"),
          peg$decode("/\u0146\"\"1(3\u0147"),
          peg$decode("/\u0148\"\"1$3\u0149"),
          ...
          peg$decode("/\u016D\"\"1%3\u016E"),
          peg$decode("/\u016F\"\"1)3\u0170"),
          peg$decode("/\xEC\"\"1\"3\xED"),
          peg$decode("/\u0171\"\"1%3\u0172"),
          peg$decode("/\u0173\"\"1'3\u0174"),
          peg$decode("/\u0175\"\"1)3\u0176"),
          peg$decode("/\u0177\"\"1%3\u0178"),
          peg$decode("!7{+3$/\u0179\"\"1&3\u017A+#%'\"%$\"# !\"# !"),
          peg$decode("/\u017B\"\"1'3\u017C"),
          peg$decode("/\u017D\"\"1)3\u017E"),
          peg$decode("/\u017F\"\"1$3\u0180"),
          peg$decode("/\xE8\"\"1\"3\xE9"),
          peg$decode("/\u0181\"\"1&3\u0182"),
          peg$decode("/\u0183\"\"1$3\u0184"),
          peg$decode("/\u0185\"\"1#3\u0186"),
          peg$decode("/\u0187\"\"1$3\u0188"),
          ...
          peg$decode("/\u01AD\"\"1'3\u01AE"),
          peg$decode("/\u01AF\"\"1&3\u01B0"),
          peg$decode("!7{+3$/\u01B1\"\"1'3\u01B2+#%'\"%$\"# !\"# !"),
          peg$decode("/\u01B3\"\"1(3\u01B4"),
          peg$decode("/\u01B5\"\"1(3\u01B6"),
          peg$decode("/\u01B7\"\"1#3\u01B8"),
          peg$decode("/\u01B9\"\"1)3\u01BA"),
          peg$decode("!7{+3$/\u01BB\"\"1&3\u01BC+#%'\"%$\"# !\"# !"),
          peg$decode("/\u01BD\"\"1#3\u01BE"),
          peg$decode("/\u01BF\"\"1'3\u01C0"),
          peg$decode("/\u01C1\"\"1%3\u01C2"),
          peg$decode("/\u01C3\"\"1$3\u01C4"),
