  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode("!7V+d$ #!7\x84+-$7V+#%'\"%$\"# \"\"# \",8&!7\x84+-$7V+#%'\"%$\"# \"\"# \"\"+(%4\"6.\"! %$\"# \"\"# \""),
          peg$decode("!!!7,+-$7\x84+#%'\"%$\"# \"\"# \"*# \" $+3$7\x90+)%4\"6/\"\"! %$\"# \"\"# \"+\xE3$ #!7\x84+l$7V+b%7\x84+X%!7,+-$7\x84+#%'\"%$\"# \"\"# \"*# \" $+3%7\x90+)%4%6/%\"! %$%# \"$$# \"$## \"$\"# \"\"# \",w&!7\x84+l$7V+b%7\x84+X%!7,+-$7\x84+#%'\"%$\"# \"\"# \"*# \" $+3%7\x90+)%4%6/%\"! %$%# \"$$# \"$## \"$\"# \"\"# \"\"+)%4\"60\"\"! %$\"# \"\"# \""),
          peg$decode("!7`+a$7\x84+W%!7,+-$7\x84+#%'\"%$\"# \"\"# \"*# \" $+2%7a+(%4$61$!!%$$# \"$## \"$\"# \"\"# \"*\xD3 \"!7`+P$7\x84+F%7-+<%7\x84+2%7a+(%4%62%!\"%$%# \"$$# \"$## \"$\"# \"\"# \"*\x95 \"!7`+\x8A$7\x84+\x80%7-+v%7\x84+l%7V+b%7\x84+X%!7,+-$7\x84+#%'\"%$\"# \"\"# \"*# \" $+3%7a+)%4(63(\"%!%$(# \"$'# \"$&# \"$%# \"$$# \"$## \"$\"# \"\"# \""),
          ...
          peg$decode("!!87x9*$$\"\" P\"# \"+2$7=+(%4\"6Q\"! %$\"# \"\"# \""),
          peg$decode("8!79+F$!87;*# \"719*$$\"\" P\"# \"+(%4\"6S\"!!%$\"# \"\"# \"*Q \"!77+F$!87;*# \"719*$$\"\" P\"# \"+(%4\"6S\"!!%$\"# \"\"# \"9*\" 3R"),
          peg$decode("87\xD9*# \"7\xE99*\" 3T"),
          peg$decode(".U\"\"2U3V"),
          peg$decode("8!7b+D$ #7C,#&7C\"+2%7c+(%4#6X#!!%$## \"$\"# \"\"# \"9*\" 3W"),
          peg$decode("!!87c*) \"7A*# \"7\x829*$$\"\" P\"# \"+1$7:+'%4\"6Y\" %$\"# \"\"# \"*C \"!7A+2$7J+(%4\"6Z\"! %$\"# \"\"# \"*# \"7I"),
          peg$decode(".[\"\"2[3\\"),
          peg$decode(".]\"\"2]3^"),
          peg$decode("8!7D+D$ #7G,#&7G\"+2%7D+(%4#6`#!!%$## \"$\"# \"\"# \"*O \"!7E+D$ #7H,#&7H\"+2%7E+(%4#6`#!!%$## \"$\"# \"\"# \"9*\" 3_"),
          peg$decode("!!87D*) \"7A*# \"7\x829*$$\"\" P\"# \"+1$7:+'%4\"6Y\" %$\"# \"\"# \"*C \"!7A+2$7J+(%4\"6Z\"! %$\"# \"\"# \"*# \"7I"),
          peg$decode("!!87E*) \"7A*# \"7\x829*$$\"\" P\"# \"+1$7:+'%4\"6Y\" %$\"# \"\"# \"*C \"!7A+2$7J+(%4\"6Z\"! %$\"# \"\"# \"*# \"7I"),
          peg$decode("!7A+1$7\x83+'%4\"6a\" %$\"# \"\"# \""),
          peg$decode("7K*\\ \"!.<\"\"2<3=+?$!8719*$$\"\" P\"# \"+'%4\"6b\" %$\"# \"\"# \"*) \"7O*# \"7P"),
          peg$decode("7L*# \"7M"),
          peg$decode("7E*\xB3 \"7D*\xAD \"7A*\xA7 \"!.c\"\"2c3d+& 4!6e! %*\x90 \"!.f\"\"2f3g+& 4!6h! %*y \"!.i\"\"2i3j+& 4!6k! %*b \"!.l\"\"2l3m+& 4!6n! %*K \"!.o\"\"2o3p+& 4!6q! %*4 \"!.r\"\"2r3s+& 4!6t! %"),
          peg$decode("!!87N*# \"7\x829*$$\"\" P\"# \"+1$7:+'%4\"6Y\" %$\"# \"\"# \""),
          peg$decode("7L*; \"71*5 \".u\"\"2u3v*) \".w\"\"2w3x"),
          peg$decode("!.u\"\"2u3v+M$!!78+-$78+#%'\"%$\"# \"\"# \"+! (%+(%4\"6y\"! %$\"# \"\"# \""),
          peg$decode("!.w\"\"2w3x+a$!!78+A$78+7%78+-%78+#%'$%$$# \"$## \"$\"# \"\"# \"+! (%+(%4\"6y\"! %$\"# \"\"# \""),
          peg$decode("87S*# \"7R9*\" 3z"),
          peg$decode("!7p+{$ #!!87\x829*$$\"\" P\"# \"+-$7:+#%'\"%$\"# \"\"# \",F&!!87\x829*$$\"\" P\"# \"+-$7:+#%'\"%$\"# \"\"# \"\"+#%'\"%$\"# \"\"# \""),
          peg$decode("!7q+\x85$ #!!87r9*$$\"\" P\"# \"+-$7:+#%'\"%$\"# \"\"# \",F&!!87r9*$$\"\" P\"# \"+-$7:+#%'\"%$\"# \"\"# \"\"+-%7r+#%'#%$## \"$\"# \"\"# \""),
          peg$decode("!7q+\x91$ #!!87r*# \"7\x829*$$\"\" P\"# \"+-$7:+#%'\"%$\"# \"\"# \",L&!!87r*# \"7\x829*$$\"\" P\"# \"+-$7:+#%'\"%$\"# \"\"# \"\"+-%7r+#%'#%$## \"$\"# \"\"# \""),
          peg$decode(".{\"\"2{3|"),
          peg$decode(".}\"\"2}3~"),
          peg$decode(".\"\"23\x80"),
          ...
          peg$decode(" #0\xAD\"\"1!3\xAE,)&0\xAD\"\"1!3\xAE\""),
          peg$decode(".\xAF\"\"2\xAF3\xB0*# \"7Y"),
          peg$decode(".\xB1\"\"2\xB13\xB2"),
          peg$decode(".\xB3\"\"2\xB33\xB4"),
          peg$decode("! #-\"\"1!3K,(&-\"\"1!3K\"+A$!8.\xB3\"\"2\xB33\xB49+$$\"# P\"\" \"+#%'\"%$\"# \"\"# \""),
          peg$decode(" \xB5"),
          peg$decode("7\xA3*\xA1 \"7\xA5*\x9B \"7\xAA*\x95 \"7\xAB*\x8F \"7\xAE*\x89 \"7\xAF*\x83 \"7\xC3*} \"7\xC4*w \"7\xC5*q \"7\xC8*k \"7\xCE*e \"7\xD2*_ \"7\xD6*Y \"7\xE1*S \"7\xE2*M \"7\xE6*G \"7\xEC*A \"7\xED*; \"7\xF3*5 \"7\u010C*/ \"7\u010D*) \"7\u0119*# \"7\u011A"),
          peg$decode("8!7\xEE+& 4!6\xB7! %9*\" 3\xB6"),
          peg$decode("8!7\u0110+& 4!6\xB9! %*. \"!7\xCB+& 4!6\xBA! %9*\" 3\xB8"),
          peg$decode("87u*) \"7v*# \"7w9*\" 3\xBB"),
          peg$decode("7[*# \"7Z"),
          ...
          peg$decode("87g*\x81 \"7h*{ \"!!7e+;$!87e9*$$\"\" P\"# \"+#%'\"%$\"# \"\"# \"+! (%*L \"!!7f+;$!87f9*$$\"\" P\"# \"+#%'\"%$\"# \"\"# \"+! (%9*\" 3\xC1"),
          ...
          peg$decode("8.\xAB\"\"2\xAB3\xAC*M \".\xD4\"\"2\xD43\xD5*A \".\xD6\"\"2\xD63\xD7*5 \".\xD8\"\"2\xD83\xD9*) \".\xDA\"\"2\xDA3\xDB9*\" 3\xD3"),
