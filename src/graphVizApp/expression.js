  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$bytecode = [
          ...
          peg$decode(".U\"\"2U3V"),
          peg$decode("!!8.P\"\"2P3Q*) \"7@*# \"7|9*$$\"\" K\"# !+1$79+'%4\"6W\" %$\"# !\"# !*I \"!.U\"\"2U3V+2$7D+(%4\"6X\"! %$\"# !\"# !*# \"7C"),
          peg$decode("!!8.S\"\"2S3T*) \"7@*# \"7|9*$$\"\" K\"# !+1$79+'%4\"6W\" %$\"# !\"# !*C \"!7@+2$7D+(%4\"6X\"! %$\"# !\"# !*# \"7C"),
          ...
          peg$decode("!!87H*# \"7|9*$$\"\" K\"# !+1$79+'%4\"6W\" %$\"# !\"# !"),
          ...
          peg$decode("!7j+{$ \"!!87|9*$$\"\" K\"# !+-$79+#%'\"%$\"# !\"# !,F&!!87|9*$$\"\" K\"# !+-$79+#%'\"%$\"# !\"# !\"+#%'\"%$\"# !\"# !"),
          peg$decode("!7k+\x85$ \"!!87l9*$$\"\" K\"# !+-$79+#%'\"%$\"# !\"# !,F&!!87l9*$$\"\" K\"# !+-$79+#%'\"%$\"# !\"# !\"+-%7l+#%'#%$## !$\"# !\"# !"),
          peg$decode("!7k+\x91$ \"!!87l*# \"7|9*$$\"\" K\"# !+-$79+#%'\"%$\"# !\"# !,L&!!87l*# \"7|9*$$\"\" K\"# !+-$79+#%'\"%$\"# !\"# !\"+-%7l+#%'#%$## !$\"# !\"# !"),
          peg$decode(".s\"\"2s3t"),
          peg$decode(".u\"\"2u3v"),
          peg$decode(".w\"\"2w3x"),
          peg$decode(".y\"\"2y3z"),
          ...
          peg$decode(" \"0\xA5\"\"1!3\xA6,)&0\xA5\"\"1!3\xA6\""),
          peg$decode(".\xA7\"\"2\xA73\xA8*# \"7S"),
          peg$decode(".\xA9\"\"2\xA93\xAA"),
          peg$decode(".\xAB\"\"2\xAB3\xAC"),
          peg$decode("! \"-\"\"1!3F,(&-\"\"1!3F\"+A$!8.\xAB\"\"2\xAB3\xAC9+$$\"# K\"\" !+#%'\"%$\"# !\"# !"),
          peg$decode(" \xAD"),
          ...
          peg$decode("8!7\xE4+& 4!6\xAF! %9*\" 3\xAE"),
          peg$decode("8!7\u0104+& 4!6\xB1! %*. \"!7\xC4+& 4!6\xB2! %9*\" 3\xB0"),
          peg$decode("87o*) \"7p*# \"7q9*\" 3\xB3"),
          peg$decode("7U*# \"7T"),
          peg$decode("!7\x8E+\x8D$ \"!7~+A$7s+7%7~+-%7\x8E+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7s+7%7~+-%7\x8E+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("8.\xB5\"\"2\xB53\xB6*) \".\xB7\"\"2\xB73\xB89*\" 3\xB4"),
          peg$decode("!7t+\x8D$ \"!7~+A$7u+7%7~+-%7t+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7u+7%7~+-%7t+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("87a*\x81 \"7b*{ \"!!7_+;$!87_9*$$\"\" K\"# !+#%'\"%$\"# !\"# !+! (%*L \"!!7`+;$!87`9*$$\"\" K\"# !+#%'\"%$\"# !\"# !+! (%9*\" 3\xB9"),
          peg$decode("!7v+\x8D$ \"!7~+A$7w+7%7~+-%7v+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7w+7%7~+-%7v+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !*# \"7\x86"),
          peg$decode("!7x+\x8D$ \"!7~+A$7z+7%7~+-%7x+#%'$%$$# !$## !$\"# !\"# !,L&!7~+A$7z+7%7~+-%7x+#%'$%$$# !$## !$\"# !\"# !\"+)%4\"6'\"\"! %$\"# !\"# !"),
          peg$decode("8.\xBB\"\"2\xBB3\xBC*M \".\xBD\"\"2\xBD3\xBE*A \".\x9D\"\"2\x9D3\x9E*5 \".\x9F\"\"2\x9F3\xA0*) \".\xA1\"\"2\xA13\xA29*\" 3\xBA"),
          ...
          peg$decode("8.\xA3\"\"2\xA33\xA4*M \".\xD0\"\"2\xD03\xD1*A \".\xD2\"\"2\xD23\xD3*5 \".\xD4\"\"2\xD43\xD5*) \".\xD6\"\"2\xD63\xD79*\" 3\xCF"),
